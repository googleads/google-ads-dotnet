...
namespace Google.Ads.Gax.Tests.Lib
{
    ...
    [TestFixture]
    [Category("Smoke")]
    internal class AdsResponseMetadataTests
    {
        ...
        public void TestGetRequestIdFromMetadata()
        {
            ...
            Assert.IsNull(new AdsResponseMetadata(metadata).RequestId);

            metadata.Add(AdsResponseMetadata.RequestIdKey, REQUEST_ID);
            Assert.AreEqual(REQUEST_ID, new AdsResponseMetadata(metadata).RequestId);
        }
        ...
        public void TestGetRequestIdFromResponse()
        {
            ...
            Assert.AreEqual(REQUEST_ID, new AdsResponseMetadata(response).RequestId);
        }
    }
}
