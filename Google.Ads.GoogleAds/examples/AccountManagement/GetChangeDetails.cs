...
using static Google.Ads.GoogleAds.V23.Enums.ChangeEventResourceTypeEnum.Types;
using static Google.Ads.GoogleAds.V23.Enums.ResourceChangeOperationEnum.Types;
using static Google.Ads.GoogleAds.V23.Resources.ChangeEvent.Types;
