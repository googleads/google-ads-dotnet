...
using static Google.Ads.GoogleAds.V25.Enums.IdentityVerificationProgramEnum.Types;
using static Google.Ads.GoogleAds.V25.Enums.IdentityVerificationProgramStatusEnum.Types;
using System;
    ...
    public class VerifyAdvertiserIdentity : ExampleBase
    {
                ...
                GoogleAdsClient client, long customerId)
        {
            IdentityVerificationServiceClient identityVerificationService =
                client.GetService(Services.V25.IdentityVerificationService);
