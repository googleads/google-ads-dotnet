...
using static Google.Ads.GoogleAds.V13.Enums.AppCampaignAppStoreEnum.Types;
using static Google.Ads.GoogleAds.V13.Enums.AppCampaignBiddingStrategyGoalTypeEnum.Types;
    ...
    public class AddAppCampaign : ExampleBase
    {
            ...
            string campaignResourceName)
        {
            ...
            CampaignCriterionServiceClient campaignCriterionService = client.GetService(
                Services.V13.CampaignCriterionService);
            ...
            string campaignResourceName)
        {
            ...
            AdGroupServiceClient adGroupService = client.GetService(Services.V13.AdGroupService);
