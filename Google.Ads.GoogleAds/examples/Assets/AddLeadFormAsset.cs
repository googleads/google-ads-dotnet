...
using static Google.Ads.GoogleAds.V19.Enums.LeadFormFieldUserInputTypeEnum.Types;
using static Google.Ads.GoogleAds.V19.Enums.LeadFormPostSubmitCallToActionTypeEnum.Types;
