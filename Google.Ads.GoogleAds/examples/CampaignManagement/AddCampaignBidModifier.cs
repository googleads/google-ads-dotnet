...
using static Google.Ads.GoogleAds.V12.Enums.InteractionTypeEnum.Types;
using static Google.Ads.GoogleAds.V12.Enums.ResponseContentTypeEnum.Types;
    ...
    public class AddCampaignBidModifier : ExampleBase
    {
            ...
            double bidModifierValue)
        {
            ...
            CampaignBidModifierServiceClient campaignBidModifierService =
                client.GetService(Services.V12.CampaignBidModifierService);
