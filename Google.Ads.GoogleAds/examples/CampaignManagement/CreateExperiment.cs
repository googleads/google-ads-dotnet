...
using System;
using System.Linq;
using static Google.Ads.GoogleAds.V23.Enums.ExperimentStatusEnum.Types;
using static Google.Ads.GoogleAds.V23.Enums.ExperimentTypeEnum.Types;
using static Google.Ads.GoogleAds.V23.Enums.ResponseContentTypeEnum.Types;
    ...
    public class CreateExperiment : ExampleBase
    {
        ...
        public void Run(GoogleAdsClient client, long customerId, long baseCampaignId)
        {
            ...
            ExperimentServiceClient experimentService = client.GetService(
                Services.V23.ExperimentService);
                ...
                string experimentResourceName)
        {
            ...
            ExperimentArmServiceClient experimentService = client.GetService(
                Services.V23.ExperimentArmService);
