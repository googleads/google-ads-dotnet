...
using System;
using System.Linq;
using static Google.Ads.GoogleAds.V22.Enums.ExperimentStatusEnum.Types;
using static Google.Ads.GoogleAds.V22.Enums.ExperimentTypeEnum.Types;
using static Google.Ads.GoogleAds.V22.Enums.ResponseContentTypeEnum.Types;
    ...
    public class CreateExperiment : ExampleBase
    {
        ...
        public void Run(GoogleAdsClient client, long customerId, long baseCampaignId)
        {
            ...
            ExperimentServiceClient experimentService = client.GetService(
                Services.V22.ExperimentService);
                ...
                string experimentResourceName)
        {
            ...
            ExperimentArmServiceClient experimentService = client.GetService(
                Services.V22.ExperimentArmService);
