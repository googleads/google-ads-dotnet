...
using System;
using System.Linq;
using static Google.Ads.GoogleAds.V21.Enums.ExperimentStatusEnum.Types;
using static Google.Ads.GoogleAds.V21.Enums.ExperimentTypeEnum.Types;
using static Google.Ads.GoogleAds.V21.Enums.ResponseContentTypeEnum.Types;
    ...
    public class CreateExperiment : ExampleBase
    {
                ...
                string experimentResourceName)
        {
            ...
            ExperimentArmServiceClient experimentService = client.GetService(
                Services.V21.ExperimentArmService);
