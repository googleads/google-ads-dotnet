...
using System;
using static Google.Ads.GoogleAds.V25.Services.DismissRecommendationRequest.Types;
using static Google.Ads.GoogleAds.V25.Services.DismissRecommendationResponse.Types;
