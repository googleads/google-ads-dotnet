...
using System;
using static Google.Ads.GoogleAds.V21.Services.DismissRecommendationRequest.Types;
using static Google.Ads.GoogleAds.V21.Services.DismissRecommendationResponse.Types;
