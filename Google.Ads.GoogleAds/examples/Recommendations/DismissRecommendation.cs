...
using static Google.Ads.GoogleAds.V12.Services.DismissRecommendationRequest.Types;
using static Google.Ads.GoogleAds.V12.Services.DismissRecommendationResponse.Types;
