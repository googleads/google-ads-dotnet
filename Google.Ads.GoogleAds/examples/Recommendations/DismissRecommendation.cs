...
using System;
using static Google.Ads.GoogleAds.V18.Services.DismissRecommendationRequest.Types;
using static Google.Ads.GoogleAds.V18.Services.DismissRecommendationResponse.Types;
