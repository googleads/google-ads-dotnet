...
using System.Text;
using static Google.Ads.GoogleAds.V24.Enums.ConsentStatusEnum.Types;
using static Google.Ads.GoogleAds.V24.Enums.CustomerMatchUploadKeyTypeEnum.Types;
using static Google.Ads.GoogleAds.V24.Enums.OfflineUserDataJobStatusEnum.Types;
using static Google.Ads.GoogleAds.V24.Enums.OfflineUserDataJobTypeEnum.Types;
...
namespace Google.Ads.GoogleAds.Examples.V24
{
    ...
    public class AddCustomerMatchUserList : ExampleBase
    {
        ...
        private string CreateCustomerMatchUserList(GoogleAdsClient client, long customerId)
        {
            ...
            UserListServiceClient service = client.GetService(Services.V24.UserListService);
            ...
            ConsentStatus? adUserDataConsent)
        {
            ...
            OfflineUserDataJobServiceClient service = client.GetService(
                Services.V24.OfflineUserDataJobService);
            ...
            string offlineUserDataJobResourceName)
        {
            ...
            GoogleAdsServiceClient service = client.GetService(Services.V24.GoogleAdsService);
