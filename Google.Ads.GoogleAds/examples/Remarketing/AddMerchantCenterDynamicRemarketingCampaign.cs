...
using static Google.Ads.GoogleAds.V12.Enums.DisplayAdFormatSettingEnum.Types;
    ...
    public class AddMerchantCenterDynamicRemarketingCampaign : ExampleBase
    {
            ...
            long merchantCenterAccountId, long campaignBudgetId)
        {
            ...
            CampaignServiceClient campaignServiceClient =
                client.GetService(Services.V12.CampaignService);
            ...
            string campaignResourceName)
        {
            ...
            AdGroupServiceClient adGroupServiceClient =
                client.GetService(Services.V12.AdGroupService);
