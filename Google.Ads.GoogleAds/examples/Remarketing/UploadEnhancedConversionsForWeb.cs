...
using System.Text;
using static Google.Ads.GoogleAds.V25.Enums.ConversionAdjustmentTypeEnum.Types;
using static Google.Ads.GoogleAds.V25.Enums.UserIdentifierSourceEnum.Types;
