...
using static Google.Ads.GoogleAds.V19.Enums.ProductCustomAttributeIndexEnum.Types;
using static Google.Ads.GoogleAds.V19.Enums.ProductTypeLevelEnum.Types;
