...
using static Google.Ads.GoogleAds.V23.Enums.ProductCustomAttributeIndexEnum.Types;
using static Google.Ads.GoogleAds.V23.Enums.ProductTypeLevelEnum.Types;
