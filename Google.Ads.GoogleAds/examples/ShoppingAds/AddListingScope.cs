...
using static Google.Ads.GoogleAds.V25.Enums.ProductCustomAttributeIndexEnum.Types;
using static Google.Ads.GoogleAds.V25.Enums.ProductTypeLevelEnum.Types;
