...
using static Google.Ads.GoogleAds.V12.Enums.ProductCustomAttributeIndexEnum.Types;
using static Google.Ads.GoogleAds.V12.Enums.ProductTypeLevelEnum.Types;
