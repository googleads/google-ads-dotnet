...
using static Google.Ads.GoogleAds.V20.Enums.ProductCustomAttributeIndexEnum.Types;
using static Google.Ads.GoogleAds.V20.Enums.ProductTypeLevelEnum.Types;
