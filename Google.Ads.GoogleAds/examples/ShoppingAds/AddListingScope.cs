...
using static Google.Ads.GoogleAds.V22.Enums.ProductCustomAttributeIndexEnum.Types;
using static Google.Ads.GoogleAds.V22.Enums.ProductTypeLevelEnum.Types;
