...
using static Google.Ads.GoogleAds.V24.Enums.ProductCustomAttributeIndexEnum.Types;
using static Google.Ads.GoogleAds.V24.Enums.ProductTypeLevelEnum.Types;
