...
using static Google.Ads.GoogleAds.V18.Enums.ProductCustomAttributeIndexEnum.Types;
using static Google.Ads.GoogleAds.V18.Enums.ProductTypeLevelEnum.Types;
