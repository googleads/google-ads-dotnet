...
using static Google.Ads.GoogleAds.V21.Enums.ProductCustomAttributeIndexEnum.Types;
using static Google.Ads.GoogleAds.V21.Enums.ProductTypeLevelEnum.Types;
