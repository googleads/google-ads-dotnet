...
namespace Google.Ads.GoogleAds.Examples.V22
{
    ...
    public class AddHotelAd : ExampleBase
    {
            ...
            string budgetResourceName, long hotelCenterAccountId, long cpcBidCeilingMicroAmount)
        {
            ...
            CampaignServiceClient service = client.GetService(Services.V22.CampaignService);
            ...
            string campaignResourceName)
        {
            ...
            AdGroupServiceClient service = client.GetService(Services.V22.AdGroupService);
