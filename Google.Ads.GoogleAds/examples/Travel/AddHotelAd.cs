...
namespace Google.Ads.GoogleAds.Examples.V24
{
    ...
    public class AddHotelAd : ExampleBase
    {
            ...
            string budgetResourceName, long hotelCenterAccountId, long cpcBidCeilingMicroAmount)
        {
            ...
            CampaignServiceClient service = client.GetService(Services.V24.CampaignService);
            ...
            string campaignResourceName)
        {
            ...
            AdGroupServiceClient service = client.GetService(Services.V24.AdGroupService);
            ...
            string adGroupResourceName)
        {
            ...
            AdGroupAdServiceClient service = client.GetService(Services.V24.AdGroupAdService);
