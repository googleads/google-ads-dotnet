...
namespace Google.Ads.GoogleAds.V10.Services
{
    ...
    internal sealed partial class AudienceServiceClientBuilder : gaxgrpc::ClientBuilderBase<AudienceServiceClient>
    {
        ...
        public AudienceServiceClientBuilder()
        {
            UseJwtAccessWithScopes = AudienceServiceClient.UseJwtAccessWithScopes;
        }
        ...
        private AudienceServiceClient BuildImpl()
        {
            ...
            return AudienceServiceClient.Create(callInvoker, Settings);
        }
        ...
        protected override string GetDefaultEndpoint() => AudienceServiceClient.DefaultEndpoint;

        /// <summary>
        /// Returns the default scopes for this builder type, used if no scopes are otherwise specified.
        /// </summary>
        protected override scg::IReadOnlyList<string> GetDefaultScopes() => AudienceServiceClient.DefaultScopes;
    ...
    public abstract partial class AudienceServiceClient
    {
        ...
        /// <returns>The created <see cref="AudienceServiceClient"/>.</returns>
        internal static AudienceServiceClient Create(grpccore::CallInvoker callInvoker, AudienceServiceSettings settings = null)
        {
    ...
    public sealed partial class AudienceServiceClientImpl : AudienceServiceClient
    {
        ...
        public AudienceServiceClientImpl(AudienceService.AudienceServiceClient grpcClient, AudienceServiceSettings settings)
        {
            GrpcClient = grpcClient;
            AudienceServiceSettings effectiveSettings = settings ?? AudienceServiceSettings.GetDefault();
            gaxgrpc::ClientHelper clientHelper = new gaxgrpc::ClientHelper(effectiveSettings);
            _callMutateAudiences = clientHelper.BuildApiCall<MutateAudiencesRequest, MutateAudiencesResponse>(grpcClient.MutateAudiencesAsync, grpcClient.MutateAudiences, effectiveSettings.MutateAudiencesSettings).WithGoogleRequestParam("customer_id", request => request.CustomerId);
