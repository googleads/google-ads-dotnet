...
namespace Google.Ads.GoogleAds.V10.Services
{
    ...
    public abstract partial class CampaignExperimentServiceClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual GraduateCampaignExperimentResponse GraduateCampaignExperiment(gagvr::CampaignExperimentName campaignExperiment, string campaignBudget, gaxgrpc::CallSettings callSettings = null) =>
            GraduateCampaignExperiment(new GraduateCampaignExperimentRequest
            {
                CampaignExperimentAsCampaignExperimentName = gax::GaxPreconditions.CheckNotNull(campaignExperiment, nameof(campaignExperiment)),
                CampaignBudget = gax::GaxPreconditions.CheckNotNullOrEmpty(campaignBudget, nameof(campaignBudget)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<GraduateCampaignExperimentResponse> GraduateCampaignExperimentAsync(gagvr::CampaignExperimentName campaignExperiment, string campaignBudget, gaxgrpc::CallSettings callSettings = null) =>
            GraduateCampaignExperimentAsync(new GraduateCampaignExperimentRequest
            {
                CampaignExperimentAsCampaignExperimentName = gax::GaxPreconditions.CheckNotNull(campaignExperiment, nameof(campaignExperiment)),
                CampaignBudget = gax::GaxPreconditions.CheckNotNullOrEmpty(campaignBudget, nameof(campaignBudget)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<GraduateCampaignExperimentResponse> GraduateCampaignExperimentAsync(gagvr::CampaignExperimentName campaignExperiment, string campaignBudget, st::CancellationToken cancellationToken) =>
            GraduateCampaignExperimentAsync(campaignExperiment, campaignBudget, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<wkt::Empty, wkt::Empty> PromoteCampaignExperiment(gagvr::CampaignExperimentName campaignExperiment, gaxgrpc::CallSettings callSettings = null) =>
            PromoteCampaignExperiment(new PromoteCampaignExperimentRequest
            {
                CampaignExperimentAsCampaignExperimentName = gax::GaxPreconditions.CheckNotNull(campaignExperiment, nameof(campaignExperiment)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<wkt::Empty, wkt::Empty>> PromoteCampaignExperimentAsync(gagvr::CampaignExperimentName campaignExperiment, gaxgrpc::CallSettings callSettings = null) =>
            PromoteCampaignExperimentAsync(new PromoteCampaignExperimentRequest
            {
                CampaignExperimentAsCampaignExperimentName = gax::GaxPreconditions.CheckNotNull(campaignExperiment, nameof(campaignExperiment)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<wkt::Empty, wkt::Empty>> PromoteCampaignExperimentAsync(gagvr::CampaignExperimentName campaignExperiment, st::CancellationToken cancellationToken) =>
            PromoteCampaignExperimentAsync(campaignExperiment, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual void EndCampaignExperiment(gagvr::CampaignExperimentName campaignExperiment, gaxgrpc::CallSettings callSettings = null) =>
            EndCampaignExperiment(new EndCampaignExperimentRequest
            {
                CampaignExperimentAsCampaignExperimentName = gax::GaxPreconditions.CheckNotNull(campaignExperiment, nameof(campaignExperiment)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task EndCampaignExperimentAsync(gagvr::CampaignExperimentName campaignExperiment, gaxgrpc::CallSettings callSettings = null) =>
            EndCampaignExperimentAsync(new EndCampaignExperimentRequest
            {
                CampaignExperimentAsCampaignExperimentName = gax::GaxPreconditions.CheckNotNull(campaignExperiment, nameof(campaignExperiment)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task EndCampaignExperimentAsync(gagvr::CampaignExperimentName campaignExperiment, st::CancellationToken cancellationToken) =>
            EndCampaignExperimentAsync(campaignExperiment, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
