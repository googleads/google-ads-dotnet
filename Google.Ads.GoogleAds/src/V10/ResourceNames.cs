...
using static Google.Ads.GoogleAds.V10.Enums.FeedItemTargetTypeEnum.Types;
using static Google.Ads.GoogleAds.V10.Enums.PlaceholderTypeEnum.Types;
using static Google.Ads.GoogleAds.V10.Enums.ProductBiddingCategoryLevelEnum.Types;
using static Google.Ads.GoogleAds.V10.Enums.SimulationModificationMethodEnum.Types;
using static Google.Ads.GoogleAds.V10.Enums.SimulationTypeEnum.Types;
