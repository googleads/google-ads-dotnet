...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static partial class ServiceCollectionExtensions
    {
        ...
        /// <summary>
        /// Adds a singleton <see cref="gagvs::CampaignExperimentServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        internal static IServiceCollection AddCampaignExperimentServiceClient(this IServiceCollection services, sys::Action<gagvs::CampaignExperimentServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gagvs::CampaignExperimentServiceClientBuilder builder = new gagvs::CampaignExperimentServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <summary>
        /// Adds a singleton <see cref="gagvs::MediaFileServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        internal static IServiceCollection AddMediaFileServiceClient(this IServiceCollection services, sys::Action<gagvs::MediaFileServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gagvs::MediaFileServiceClientBuilder builder = new gagvs::MediaFileServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });

        /// <summary>
        /// Adds a singleton <see cref="gagvs::MerchantCenterLinkServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        internal static IServiceCollection AddMerchantCenterLinkServiceClient(this IServiceCollection services, sys::Action<gagvs::MerchantCenterLinkServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gagvs::MerchantCenterLinkServiceClientBuilder builder = new gagvs::MerchantCenterLinkServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
