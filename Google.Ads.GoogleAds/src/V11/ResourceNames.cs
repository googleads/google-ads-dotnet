...
using static Google.Ads.GoogleAds.V11.Enums.FeedItemTargetTypeEnum.Types;
using static Google.Ads.GoogleAds.V11.Enums.PlaceholderTypeEnum.Types;
using static Google.Ads.GoogleAds.V11.Enums.ProductBiddingCategoryLevelEnum.Types;
using static Google.Ads.GoogleAds.V11.Enums.SimulationModificationMethodEnum.Types;
using static Google.Ads.GoogleAds.V11.Enums.SimulationTypeEnum.Types;
