...
namespace Google.Ads.GoogleAds.V13.Services
{
    public partial class KeywordPlanOperation
    {
        ...
        /// </summary>
        internal gagvr::KeywordPlanName RemoveAsKeywordPlanName
        {
    ...
    public partial class MutateKeywordPlansResult
    {
        /// <summary>
        /// <see cref="gagvr::KeywordPlanName"/>-typed view over the <see cref="ResourceName"/> resource name property.
        /// </summary>
        internal gagvr::KeywordPlanName ResourceNameAsKeywordPlanName
        {
    ...
    public partial class GenerateForecastCurveRequest
    {
        ...
        /// </summary>
        internal gagvr::KeywordPlanName KeywordPlanAsKeywordPlanName
        {
