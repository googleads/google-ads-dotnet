...
using static Google.Ads.GoogleAds.V13.Enums.FeedItemTargetTypeEnum.Types;
using static Google.Ads.GoogleAds.V13.Enums.PlaceholderTypeEnum.Types;
using static Google.Ads.GoogleAds.V13.Enums.ProductBiddingCategoryLevelEnum.Types;
using static Google.Ads.GoogleAds.V13.Enums.SimulationModificationMethodEnum.Types;
using static Google.Ads.GoogleAds.V13.Enums.SimulationTypeEnum.Types;
