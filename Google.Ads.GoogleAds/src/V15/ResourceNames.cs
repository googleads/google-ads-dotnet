...
using System.Linq;
using System.Text;
using static Google.Ads.GoogleAds.V15.Enums.AndroidPrivacyInteractionTypeEnum.Types;
using static Google.Ads.GoogleAds.V15.Enums.AndroidPrivacyNetworkTypeEnum.Types;
...
using static Google.Ads.GoogleAds.V15.Enums.FeedItemTargetTypeEnum.Types;
using static Google.Ads.GoogleAds.V15.Enums.PlaceholderTypeEnum.Types;
using static Google.Ads.GoogleAds.V15.Enums.ProductCategoryLevelEnum.Types;
using static Google.Ads.GoogleAds.V15.Enums.SimulationModificationMethodEnum.Types;
using static Google.Ads.GoogleAds.V15.Enums.SimulationTypeEnum.Types;
...
namespace Google.Ads.GoogleAds.V15.Errors
{
    ...
    public class ResourceNames
    {
        ...
        public static string AndroidPrivacySharedKeyGoogleAdGroup(long customerId,
        ...
        {
            return AndroidPrivacySharedKeyGoogleAdGroupName.Format(customerId.ToString(),
                campaignId.ToString(), adGroupId.ToString(),
                ProtobufUtilities.GetOriginalEnumFieldName(androidPrivacyInteractionType),
                ProtobufUtilities.GetOriginalEnumFieldName(androidPrivacyNetworkType),
                androidPrivacyInteractionDate);
        }

        public static string AndroidPrivacySharedKeyGoogleCampaign(long customerId,
            long campaignId,
            AndroidPrivacyInteractionType androidPrivacyInteractionType,
            string androidPrivacyInteractionDate)
        {
            return AndroidPrivacySharedKeyGoogleCampaignName.Format(customerId.ToString(),
                campaignId.ToString(),
                ProtobufUtilities.GetOriginalEnumFieldName(androidPrivacyInteractionType),
                androidPrivacyInteractionDate);
        }

        public static string AndroidPrivacySharedKeyGoogleNetworkType(long customerId,
            long campaignId,
            AndroidPrivacyInteractionType androidPrivacyInteractionType,
            AndroidPrivacyNetworkType androidPrivacyNetworkType,
            string androidPrivacyInteractionDate)
        {
            return AndroidPrivacySharedKeyGoogleNetworkTypeName.Format(customerId.ToString(),
                campaignId.ToString(),
                ProtobufUtilities.GetOriginalEnumFieldName(androidPrivacyInteractionType),
                ProtobufUtilities.GetOriginalEnumFieldName(androidPrivacyNetworkType),
                androidPrivacyInteractionDate);
        ...
        public static string AssetGroupTopCombinationView(long customerId, long assetGroupId,
            long assetCombinationCategoryId)
        {
            return AssetGroupTopCombinationViewName.Format(customerId.ToString(),
                assetGroupId.ToString(), assetCombinationCategoryId.ToString());
        }
        ...
        {
            return CampaignLifecycleGoalName.Format(customerId.ToString(), campaignId.ToString());
        }
        ...
        {
            return CustomerLifecycleGoalName.Format(customerId.ToString());
        }
        ...
        {
            return LocalServicesLeadName.Format(customerId.ToString(),
                localServicesLeadId.ToString());
        }

        public static string LocalServicesLeadConversation(long customerId,
            long localServicesLeadConversationId)
        {
            return LocalServicesLeadConversationName.Format(customerId.ToString(),
                localServicesLeadConversationId.ToString());
        }

        public static string LocalServicesVerificationArtifact(long customerId,
            long glsVerificationArtifactId)
        {
            return LocalServicesVerificationArtifactName.Format(customerId.ToString(),
                glsVerificationArtifactId.ToString());
        }
        ...
        public static string OfflineConversionUploadClientSummary(long customerId, long clientId)
        {
            return OfflineConversionUploadClientSummaryName.Format(customerId.ToString(),
                clientId.ToString());
        }
        ...
        public static string ProductCategoryConstant(ProductCategoryLevel level, long id)
        {
            return ProductCategoryConstantName.Format(level.ToString(), id.ToString());
        }
        ...
        public static string ProductLinkInvitation(long customerId, long customerInvitationId)
        {
            return ProductLinkInvitationName.Format(customerId.ToString(),
                customerInvitationId.ToString());
        }

        public static string QualifyingQuestion(long qualifyingQuestionId)
        {
        ...
        public static string RecommendationSubscription(long customerId,
            long recommendationSubscriptionId)
        {
            return RecommendationSubscriptionName.Format(customerId.ToString(),
                recommendationSubscriptionId.ToString());
        }
        ...
        public static string TravelActivityGroupView(long customerId, long adGroupId,
            long criterionId)
        {
