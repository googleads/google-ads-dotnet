...
namespace Google.Ads.GoogleAds.V16.Services
{
    ...
    internal sealed partial class CampaignCriterionServiceClientBuilder : gaxgrpc::ClientBuilderBase<CampaignCriterionServiceClient>
    {
        ...
        public CampaignCriterionServiceClientBuilder() : base(CampaignCriterionServiceClient.ServiceMetadata)
        {
        }
        ...
        private CampaignCriterionServiceClient BuildImpl()
        {
            ...
            return CampaignCriterionServiceClient.Create(callInvoker, GetEffectiveSettings(Settings?.Clone()), Logger);
        }
    ...
    public abstract partial class CampaignCriterionServiceClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(CampaignCriterionService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
        ...
        /// <returns>The created <see cref="CampaignCriterionServiceClient"/>.</returns>
        internal static CampaignCriterionServiceClient Create(grpccore::CallInvoker callInvoker, CampaignCriterionServiceSettings settings = null, mel::ILogger logger = null)
        {
            ...
            return new CampaignCriterionServiceClientImpl(grpcClient, settings, logger);
        }
    ...
    public sealed partial class CampaignCriterionServiceClientImpl : CampaignCriterionServiceClient
    {
        ...
        public CampaignCriterionServiceClientImpl(CampaignCriterionService.CampaignCriterionServiceClient grpcClient, CampaignCriterionServiceSettings settings, mel::ILogger logger)
        {
            ...
            _callMutateCampaignCriteria = clientHelper.BuildApiCall<MutateCampaignCriteriaRequest, MutateCampaignCriteriaResponse>("MutateCampaignCriteria", grpcClient.MutateCampaignCriteriaAsync, grpcClient.MutateCampaignCriteria, effectiveSettings.MutateCampaignCriteriaSettings).WithGoogleRequestParam("customer_id", request => request.CustomerId);
