...
namespace Google.Ads.GoogleAds.V16.Services
{
    ...
    internal sealed partial class CustomerCustomizerServiceClientBuilder : gaxgrpc::ClientBuilderBase<CustomerCustomizerServiceClient>
    {
        ...
        public CustomerCustomizerServiceClientBuilder() : base(CustomerCustomizerServiceClient.ServiceMetadata)
        {
        }
        ...
        private CustomerCustomizerServiceClient BuildImpl()
        {
            ...
            return CustomerCustomizerServiceClient.Create(callInvoker, GetEffectiveSettings(Settings?.Clone()), Logger);
        }
    ...
    public abstract partial class CustomerCustomizerServiceClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(CustomerCustomizerService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
        ...
        /// <returns>The created <see cref="CustomerCustomizerServiceClient"/>.</returns>
        internal static CustomerCustomizerServiceClient Create(grpccore::CallInvoker callInvoker, CustomerCustomizerServiceSettings settings = null, mel::ILogger logger = null)
        {
            ...
            return new CustomerCustomizerServiceClientImpl(grpcClient, settings, logger);
        }
    ...
    public sealed partial class CustomerCustomizerServiceClientImpl : CustomerCustomizerServiceClient
    {
        ...
        public CustomerCustomizerServiceClientImpl(CustomerCustomizerService.CustomerCustomizerServiceClient grpcClient, CustomerCustomizerServiceSettings settings, mel::ILogger logger)
        {
            ...
            _callMutateCustomerCustomizers = clientHelper.BuildApiCall<MutateCustomerCustomizersRequest, MutateCustomerCustomizersResponse>("MutateCustomerCustomizers", grpcClient.MutateCustomerCustomizersAsync, grpcClient.MutateCustomerCustomizers, effectiveSettings.MutateCustomerCustomizersSettings).WithGoogleRequestParam("customer_id", request => request.CustomerId);
