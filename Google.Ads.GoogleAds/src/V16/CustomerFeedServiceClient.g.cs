...
namespace Google.Ads.GoogleAds.V16.Services
{
    ...
    internal sealed partial class CustomerFeedServiceClientBuilder : gaxgrpc::ClientBuilderBase<CustomerFeedServiceClient>
    {
        ...
        public CustomerFeedServiceClientBuilder() : base(CustomerFeedServiceClient.ServiceMetadata)
        {
        }
        ...
        private CustomerFeedServiceClient BuildImpl()
        {
            ...
            return CustomerFeedServiceClient.Create(callInvoker, GetEffectiveSettings(Settings?.Clone()), Logger);
        }
    ...
    public abstract partial class CustomerFeedServiceClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(CustomerFeedService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
        ...
        /// <returns>The created <see cref="CustomerFeedServiceClient"/>.</returns>
        internal static CustomerFeedServiceClient Create(grpccore::CallInvoker callInvoker, CustomerFeedServiceSettings settings = null, mel::ILogger logger = null)
        {
            ...
            return new CustomerFeedServiceClientImpl(grpcClient, settings, logger);
        }
    ...
    public sealed partial class CustomerFeedServiceClientImpl : CustomerFeedServiceClient
    {
        ...
        public CustomerFeedServiceClientImpl(CustomerFeedService.CustomerFeedServiceClient grpcClient, CustomerFeedServiceSettings settings, mel::ILogger logger)
        {
            ...
            _callMutateCustomerFeeds = clientHelper.BuildApiCall<MutateCustomerFeedsRequest, MutateCustomerFeedsResponse>("MutateCustomerFeeds", grpcClient.MutateCustomerFeedsAsync, grpcClient.MutateCustomerFeeds, effectiveSettings.MutateCustomerFeedsSettings).WithGoogleRequestParam("customer_id", request => request.CustomerId);
