...
namespace Google.Ads.GoogleAds.V16.Services
{
    ...
    internal sealed partial class ExtensionFeedItemServiceClientBuilder : gaxgrpc::ClientBuilderBase<ExtensionFeedItemServiceClient>
    {
        ...
        public ExtensionFeedItemServiceClientBuilder() : base(ExtensionFeedItemServiceClient.ServiceMetadata)
        {
        }
        ...
        private ExtensionFeedItemServiceClient BuildImpl()
        {
            ...
            return ExtensionFeedItemServiceClient.Create(callInvoker, GetEffectiveSettings(Settings?.Clone()), Logger);
        }
    ...
    public abstract partial class ExtensionFeedItemServiceClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(ExtensionFeedItemService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
        ...
        /// <returns>The created <see cref="ExtensionFeedItemServiceClient"/>.</returns>
        internal static ExtensionFeedItemServiceClient Create(grpccore::CallInvoker callInvoker, ExtensionFeedItemServiceSettings settings = null, mel::ILogger logger = null)
        {
            ...
            return new ExtensionFeedItemServiceClientImpl(grpcClient, settings, logger);
        }
    ...
    public sealed partial class ExtensionFeedItemServiceClientImpl : ExtensionFeedItemServiceClient
    {
        ...
        public ExtensionFeedItemServiceClientImpl(ExtensionFeedItemService.ExtensionFeedItemServiceClient grpcClient, ExtensionFeedItemServiceSettings settings, mel::ILogger logger)
        {
            ...
            _callMutateExtensionFeedItems = clientHelper.BuildApiCall<MutateExtensionFeedItemsRequest, MutateExtensionFeedItemsResponse>("MutateExtensionFeedItems", grpcClient.MutateExtensionFeedItemsAsync, grpcClient.MutateExtensionFeedItems, effectiveSettings.MutateExtensionFeedItemsSettings).WithGoogleRequestParam("customer_id", request => request.CustomerId);
