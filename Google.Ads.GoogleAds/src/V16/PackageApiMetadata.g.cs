...
namespace Google.Ads.GoogleAds.V16.Services
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Ads.GoogleAds.V16.Services", GetFileDescriptors)
            .WithHttpRuleOverrides(new scg::Dictionary<string, proto::ByteString>
            {
                {
                    "google.longrunning.Operations.CancelOperation",
                    // { "post": "/v16/{name=customers/*/operations/*}:cancel", "body": "*" }
                    proto::ByteString.FromBase64("IisvdjE2L3tuYW1lPWN1c3RvbWVycy8qL29wZXJhdGlvbnMvKn06Y2FuY2VsOgEq")
                },
                {
                    "google.longrunning.Operations.DeleteOperation",
                    // { "delete": "/v16/{name=customers/*/operations/*}" }
                    proto::ByteString.FromBase64("KiQvdjE2L3tuYW1lPWN1c3RvbWVycy8qL29wZXJhdGlvbnMvKn0=")
                },
                {
                    "google.longrunning.Operations.GetOperation",
                    // { "get": "/v16/{name=customers/*/operations/*}" }
                    proto::ByteString.FromBase64("EiQvdjE2L3tuYW1lPWN1c3RvbWVycy8qL29wZXJhdGlvbnMvKn0=")
                },
                {
                    "google.longrunning.Operations.ListOperations",
                    // { "get": "/v16/{name=customers/*/operations}" }
                    proto::ByteString.FromBase64("EiIvdjE2L3tuYW1lPWN1c3RvbWVycy8qL29wZXJhdGlvbnN9")
                },
                {
                    "google.longrunning.Operations.WaitOperation",
                    // { "post": "/v16/{name=customers/*/operations/*}:wait", "body": "*" }
                    proto::ByteString.FromBase64("IikvdjE2L3tuYW1lPWN1c3RvbWVycy8qL29wZXJhdGlvbnMvKn06d2FpdDoBKg==")
                },
            });
