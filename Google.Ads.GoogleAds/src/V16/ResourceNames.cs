...
using static Google.Ads.GoogleAds.V16.Enums.ExtensionTypeEnum.Types;
using static Google.Ads.GoogleAds.V16.Enums.FeedItemTargetTypeEnum.Types;
using static Google.Ads.GoogleAds.V16.Enums.PlaceholderTypeEnum.Types;
using static Google.Ads.GoogleAds.V16.Enums.SimulationModificationMethodEnum.Types;
using static Google.Ads.GoogleAds.V16.Enums.SimulationTypeEnum.Types;
