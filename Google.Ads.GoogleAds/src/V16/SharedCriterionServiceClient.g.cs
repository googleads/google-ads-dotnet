...
namespace Google.Ads.GoogleAds.V16.Services
{
    ...
    /// endpoint etc.
    /// </summary>
    internal sealed partial class SharedCriterionServiceClientBuilder : gaxgrpc::ClientBuilderBase<SharedCriterionServiceClient>
    {
        /// <summary>The settings to use for RPCs, or <c>null</c> for the default settings.</summary>
        public SharedCriterionServiceSettings Settings { get; set; }

        /// <summary>Creates a new builder with default settings.</summary>
        public SharedCriterionServiceClientBuilder() : base(SharedCriterionServiceClient.ServiceMetadata)
        {
        }
        ...
        private SharedCriterionServiceClient BuildImpl()
        {
            ...
            return SharedCriterionServiceClient.Create(callInvoker, GetEffectiveSettings(Settings?.Clone()), Logger);
        }
    ...
    public abstract partial class SharedCriterionServiceClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(SharedCriterionService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
        ...
        /// <returns>The created <see cref="SharedCriterionServiceClient"/>.</returns>
        internal static SharedCriterionServiceClient Create(grpccore::CallInvoker callInvoker, SharedCriterionServiceSettings settings = null, mel::ILogger logger = null)
        {
            ...
            return new SharedCriterionServiceClientImpl(grpcClient, settings, logger);
        }
    ...
    public sealed partial class SharedCriterionServiceClientImpl : SharedCriterionServiceClient
    {
        ...
        public SharedCriterionServiceClientImpl(SharedCriterionService.SharedCriterionServiceClient grpcClient, SharedCriterionServiceSettings settings, mel::ILogger logger)
        {
