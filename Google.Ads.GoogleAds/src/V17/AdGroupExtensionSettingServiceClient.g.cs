...
namespace Google.Ads.GoogleAds.V17.Services
{
    ...
    /// </summary>
    internal sealed partial class AdGroupExtensionSettingServiceClientBuilder : gaxgrpc::ClientBuilderBase<AdGroupExtensionSettingServiceClient>
    {
        /// <summary>The settings to use for RPCs, or <c>null</c> for the default settings.</summary>
        public AdGroupExtensionSettingServiceSettings Settings { get; set; }

        /// <summary>Creates a new builder with default settings.</summary>
        public AdGroupExtensionSettingServiceClientBuilder() : base(AdGroupExtensionSettingServiceClient.ServiceMetadata)
        {
        }
        ...
        private AdGroupExtensionSettingServiceClient BuildImpl()
        {
            ...
            return AdGroupExtensionSettingServiceClient.Create(callInvoker, GetEffectiveSettings(Settings?.Clone()), Logger);
        }
    ...
    public abstract partial class AdGroupExtensionSettingServiceClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(AdGroupExtensionSettingService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
        ...
        /// <returns>The created <see cref="AdGroupExtensionSettingServiceClient"/>.</returns>
        internal static AdGroupExtensionSettingServiceClient Create(grpccore::CallInvoker callInvoker, AdGroupExtensionSettingServiceSettings settings = null, mel::ILogger logger = null)
        {
            ...
            return new AdGroupExtensionSettingServiceClientImpl(grpcClient, settings, logger);
        }
    ...
    public sealed partial class AdGroupExtensionSettingServiceClientImpl : AdGroupExtensionSettingServiceClient
    {
        ...
        public AdGroupExtensionSettingServiceClientImpl(AdGroupExtensionSettingService.AdGroupExtensionSettingServiceClient grpcClient, AdGroupExtensionSettingServiceSettings settings, mel::ILogger logger)
        {
