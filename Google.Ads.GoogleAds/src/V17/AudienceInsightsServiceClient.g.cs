...
namespace Google.Ads.GoogleAds.V17.Services
{
    ...
    public abstract partial class AudienceInsightsServiceClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual GenerateSuggestedTargetingInsightsResponse GenerateSuggestedTargetingInsights(string customerId, InsightsAudience audience, gaxgrpc::CallSettings callSettings = null) =>
            GenerateSuggestedTargetingInsights(new GenerateSuggestedTargetingInsightsRequest
            {
                CustomerId = gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)),
                Audience = gax::GaxPreconditions.CheckNotNull(audience, nameof(audience)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<GenerateSuggestedTargetingInsightsResponse> GenerateSuggestedTargetingInsightsAsync(string customerId, InsightsAudience audience, gaxgrpc::CallSettings callSettings = null) =>
            GenerateSuggestedTargetingInsightsAsync(new GenerateSuggestedTargetingInsightsRequest
            {
                CustomerId = gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)),
                Audience = gax::GaxPreconditions.CheckNotNull(audience, nameof(audience)),
            }, callSettings);
