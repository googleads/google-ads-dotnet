...
namespace Google.Ads.GoogleAds.V18.Services
{
    ...
    internal sealed partial class AdGroupFeedServiceClientBuilder : gaxgrpc::ClientBuilderBase<AdGroupFeedServiceClient>
    {
        ...
        public AdGroupFeedServiceClientBuilder() : base(AdGroupFeedServiceClient.ServiceMetadata)
        {
        }
        ...
        private AdGroupFeedServiceClient BuildImpl()
        {
            ...
            return AdGroupFeedServiceClient.Create(callInvoker, GetEffectiveSettings(Settings?.Clone()), Logger);
        }
    ...
    public abstract partial class AdGroupFeedServiceClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(AdGroupFeedService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
        ...
        /// <returns>The created <see cref="AdGroupFeedServiceClient"/>.</returns>
        internal static AdGroupFeedServiceClient Create(grpccore::CallInvoker callInvoker, AdGroupFeedServiceSettings settings = null, mel::ILogger logger = null)
        {
            ...
            return new AdGroupFeedServiceClientImpl(grpcClient, settings, logger);
        }
    ...
    public sealed partial class AdGroupFeedServiceClientImpl : AdGroupFeedServiceClient
    {
        ...
        public AdGroupFeedServiceClientImpl(AdGroupFeedService.AdGroupFeedServiceClient grpcClient, AdGroupFeedServiceSettings settings, mel::ILogger logger)
        {
            ...
            _callMutateAdGroupFeeds = clientHelper.BuildApiCall<MutateAdGroupFeedsRequest, MutateAdGroupFeedsResponse>("MutateAdGroupFeeds", grpcClient.MutateAdGroupFeedsAsync, grpcClient.MutateAdGroupFeeds, effectiveSettings.MutateAdGroupFeedsSettings).WithGoogleRequestParam("customer_id", request => request.CustomerId);
