...
namespace Google.Ads.GoogleAds.V18.Resources
{
    ...
    public partial class Campaign
    {
        ...
        /// <summary>
        /// <see cref="CampaignGroupName"/>-typed view over the <see cref="CampaignGroup"/> resource name property.
        /// </summary>
        internal CampaignGroupName CampaignGroupAsCampaignGroupName
        {
            get => string.IsNullOrEmpty(CampaignGroup) ? null : CampaignGroupName.Parse(CampaignGroup, allowUnparsed: true);
            set => CampaignGroup = value?.ToString() ?? "";
        }

        /// <summary>
        /// <see cref="AssetSetName"/>-typed view over the <see cref="HotelPropertyAssetSet"/> resource name property.
        /// </summary>
        internal AssetSetName HotelPropertyAssetSetAsAssetSetName
        {
            get => string.IsNullOrEmpty(HotelPropertyAssetSet) ? null : AssetSetName.Parse(HotelPropertyAssetSet, allowUnparsed: true);
            set => HotelPropertyAssetSet = value?.ToString() ?? "";
        }

        public partial class Types
        {
            public partial class PerformanceMaxUpgrade
            {
                /// <summary>
                /// <see cref="gagvr::CampaignName"/>-typed view over the <see cref="PerformanceMaxCampaign"/> resource
                /// name property.
                /// </summary>
                internal gagvr::CampaignName PerformanceMaxCampaignAsCampaignName
                {
                    get => string.IsNullOrEmpty(PerformanceMaxCampaign) ? null : gagvr::CampaignName.Parse(PerformanceMaxCampaign, allowUnparsed: true);
                    set => PerformanceMaxCampaign = value?.ToString() ?? "";
                }

                /// <summary>
                /// <see cref="gagvr::CampaignName"/>-typed view over the <see cref="PreUpgradeCampaign"/> resource name
                /// property.
                /// </summary>
                internal gagvr::CampaignName PreUpgradeCampaignAsCampaignName
                {
                    get => string.IsNullOrEmpty(PreUpgradeCampaign) ? null : gagvr::CampaignName.Parse(PreUpgradeCampaign, allowUnparsed: true);
                    set => PreUpgradeCampaign = value?.ToString() ?? "";
                }
            }

            public partial class DynamicSearchAdsSetting
            {
                /// <summary>
                /// <see cref="FeedName"/>-typed view over the <see cref="Feeds"/> resource name property.
                /// </summary>
                internal gax::ResourceNameList<FeedName> FeedsAsFeedNames
                {
                    get => new gax::ResourceNameList<FeedName>(Feeds, s => string.IsNullOrEmpty(s) ? null : FeedName.Parse(s, allowUnparsed: true));
                }
            }
