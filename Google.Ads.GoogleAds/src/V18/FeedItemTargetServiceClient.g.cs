...
namespace Google.Ads.GoogleAds.V18.Services
{
    ...
    internal sealed partial class FeedItemTargetServiceClientBuilder : gaxgrpc::ClientBuilderBase<FeedItemTargetServiceClient>
    {
        ...
        public FeedItemTargetServiceClientBuilder() : base(FeedItemTargetServiceClient.ServiceMetadata)
        {
        }
        ...
        private FeedItemTargetServiceClient BuildImpl()
        {
            ...
            return FeedItemTargetServiceClient.Create(callInvoker, GetEffectiveSettings(Settings?.Clone()), Logger);
        }
    ...
    public abstract partial class FeedItemTargetServiceClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(FeedItemTargetService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
        ...
        /// <returns>The created <see cref="FeedItemTargetServiceClient"/>.</returns>
        internal static FeedItemTargetServiceClient Create(grpccore::CallInvoker callInvoker, FeedItemTargetServiceSettings settings = null, mel::ILogger logger = null)
        {
            ...
            return new FeedItemTargetServiceClientImpl(grpcClient, settings, logger);
        }
    ...
    public sealed partial class FeedItemTargetServiceClientImpl : FeedItemTargetServiceClient
    {
        ...
        public FeedItemTargetServiceClientImpl(FeedItemTargetService.FeedItemTargetServiceClient grpcClient, FeedItemTargetServiceSettings settings, mel::ILogger logger)
        {
