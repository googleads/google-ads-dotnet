...
using static Google.Ads.GoogleAds.V18.Enums.ExtensionTypeEnum.Types;
using static Google.Ads.GoogleAds.V18.Enums.FeedItemTargetTypeEnum.Types;
using static Google.Ads.GoogleAds.V18.Enums.PlaceholderTypeEnum.Types;
using static Google.Ads.GoogleAds.V18.Enums.SimulationModificationMethodEnum.Types;
using static Google.Ads.GoogleAds.V18.Enums.SimulationTypeEnum.Types;
...
namespace Google.Ads.GoogleAds.V18.Errors
{
    ...
    public class ResourceNames
    {
        ...
        {
            return $"customers/{customerId}/performanceMaxPlacementViews/{base64Placement}";
        }
