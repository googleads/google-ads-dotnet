...
using gagvc = Google.Ads.GoogleAds.V19.Common;
using gagve = Google.Ads.GoogleAds.V19.Enums;
...
namespace Google.Ads.GoogleAds.V19.Services
{
    ...
    public abstract partial class AudienceInsightsServiceClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual GenerateTargetingSuggestionMetricsResponse GenerateTargetingSuggestionMetrics(string customerId, scg::IEnumerable<BasicInsightsAudience> audiences, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<GenerateTargetingSuggestionMetricsResponse> GenerateTargetingSuggestionMetricsAsync(string customerId, scg::IEnumerable<BasicInsightsAudience> audiences, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<GenerateTargetingSuggestionMetricsResponse> GenerateTargetingSuggestionMetricsAsync(string customerId, scg::IEnumerable<BasicInsightsAudience> audiences, st::CancellationToken cancellationToken) =>
