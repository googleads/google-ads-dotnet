...
namespace Google.Ads.GoogleAds.V19.Services
{
    ...
    internal sealed partial class ConversionValueRuleSetServiceClientBuilder : gaxgrpc::ClientBuilderBase<ConversionValueRuleSetServiceClient>
    {
        ...
        public ConversionValueRuleSetServiceClientBuilder() : base(ConversionValueRuleSetServiceClient.ServiceMetadata)
        {
        }
        ...
        private ConversionValueRuleSetServiceClient BuildImpl()
        {
            ...
            return ConversionValueRuleSetServiceClient.Create(callInvoker, GetEffectiveSettings(Settings?.Clone()), Logger);
        }
    ...
    public abstract partial class ConversionValueRuleSetServiceClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(ConversionValueRuleSetService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
        ...
        /// <returns>The created <see cref="ConversionValueRuleSetServiceClient"/>.</returns>
        internal static ConversionValueRuleSetServiceClient Create(grpccore::CallInvoker callInvoker, ConversionValueRuleSetServiceSettings settings = null, mel::ILogger logger = null)
        {
            ...
            return new ConversionValueRuleSetServiceClientImpl(grpcClient, settings, logger);
        }
    ...
    public sealed partial class ConversionValueRuleSetServiceClientImpl : ConversionValueRuleSetServiceClient
    {
        ...
        public ConversionValueRuleSetServiceClientImpl(ConversionValueRuleSetService.ConversionValueRuleSetServiceClient grpcClient, ConversionValueRuleSetServiceSettings settings, mel::ILogger logger)
        {
            ...
            _callMutateConversionValueRuleSets = clientHelper.BuildApiCall<MutateConversionValueRuleSetsRequest, MutateConversionValueRuleSetsResponse>("MutateConversionValueRuleSets", grpcClient.MutateConversionValueRuleSetsAsync, grpcClient.MutateConversionValueRuleSets, effectiveSettings.MutateConversionValueRuleSetsSettings).WithGoogleRequestParam("customer_id", request => request.CustomerId);
