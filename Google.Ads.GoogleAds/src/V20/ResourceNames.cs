...
using static Google.Ads.GoogleAds.V20.Enums.ConversionOriginEnum.Types;
using static Google.Ads.GoogleAds.V20.Enums.SimulationModificationMethodEnum.Types;
using static Google.Ads.GoogleAds.V20.Enums.SimulationTypeEnum.Types;
