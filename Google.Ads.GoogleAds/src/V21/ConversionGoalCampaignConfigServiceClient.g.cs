...
namespace Google.Ads.GoogleAds.V21.Services
{
    ...
    internal sealed partial class ConversionGoalCampaignConfigServiceClientBuilder : gaxgrpc::ClientBuilderBase<ConversionGoalCampaignConfigServiceClient>
    {
        ...
        public ConversionGoalCampaignConfigServiceClientBuilder() : base(ConversionGoalCampaignConfigServiceClient.ServiceMetadata)
        {
        }
        ...
        private ConversionGoalCampaignConfigServiceClient BuildImpl()
        {
            ...
            return ConversionGoalCampaignConfigServiceClient.Create(callInvoker, GetEffectiveSettings(Settings?.Clone()), Logger);
        }
    ...
    public abstract partial class ConversionGoalCampaignConfigServiceClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(ConversionGoalCampaignConfigService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
        ...
        /// <returns>The created <see cref="ConversionGoalCampaignConfigServiceClient"/>.</returns>
        internal static ConversionGoalCampaignConfigServiceClient Create(grpccore::CallInvoker callInvoker, ConversionGoalCampaignConfigServiceSettings settings = null, mel::ILogger logger = null)
        {
            ...
            return new ConversionGoalCampaignConfigServiceClientImpl(grpcClient, settings, logger);
        }
    ...
    public sealed partial class ConversionGoalCampaignConfigServiceClientImpl : ConversionGoalCampaignConfigServiceClient
    {
        ...
        public ConversionGoalCampaignConfigServiceClientImpl(ConversionGoalCampaignConfigService.ConversionGoalCampaignConfigServiceClient grpcClient, ConversionGoalCampaignConfigServiceSettings settings, mel::ILogger logger)
        {
