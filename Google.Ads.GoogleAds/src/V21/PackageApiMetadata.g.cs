...
namespace Google.Ads.GoogleAds.V21.Services
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Ads.GoogleAds.V21.Services", GetFileDescriptors)
            .WithHttpRuleOverrides(new scg::Dictionary<string, proto::ByteString>
            {
                {
                    "google.longrunning.Operations.CancelOperation",
                    // { "post": "/v21/{name=customers/*/operations/*}:cancel", "body": "*" }
                    proto::ByteString.FromBase64("IisvdjIxL3tuYW1lPWN1c3RvbWVycy8qL29wZXJhdGlvbnMvKn06Y2FuY2VsOgEq")
                },
                {
                    "google.longrunning.Operations.DeleteOperation",
                    // { "delete": "/v21/{name=customers/*/operations/*}" }
                    proto::ByteString.FromBase64("KiQvdjIxL3tuYW1lPWN1c3RvbWVycy8qL29wZXJhdGlvbnMvKn0=")
                },
                {
                    "google.longrunning.Operations.GetOperation",
                    // { "get": "/v21/{name=customers/*/operations/*}" }
                    proto::ByteString.FromBase64("EiQvdjIxL3tuYW1lPWN1c3RvbWVycy8qL29wZXJhdGlvbnMvKn0=")
                },
                {
                    "google.longrunning.Operations.ListOperations",
                    // { "get": "/v21/{name=customers/*/operations}" }
                    proto::ByteString.FromBase64("EiIvdjIxL3tuYW1lPWN1c3RvbWVycy8qL29wZXJhdGlvbnN9")
                },
                {
                    "google.longrunning.Operations.WaitOperation",
                    // { "post": "/v21/{name=customers/*/operations/*}:wait", "body": "*" }
                    proto::ByteString.FromBase64("IikvdjIxL3tuYW1lPWN1c3RvbWVycy8qL29wZXJhdGlvbnMvKn06d2FpdDoBKg==")
                },
            });
