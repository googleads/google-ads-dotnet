...
namespace Google.Ads.GoogleAds.V22.Services
{
    ...
    internal sealed partial class AdGroupAssetServiceClientBuilder : gaxgrpc::ClientBuilderBase<AdGroupAssetServiceClient>
    {
        ...
        public AdGroupAssetServiceClientBuilder() : base(AdGroupAssetServiceClient.ServiceMetadata)
        {
        }
        ...
        private AdGroupAssetServiceClient BuildImpl()
        {
            ...
            return AdGroupAssetServiceClient.Create(callInvoker, GetEffectiveSettings(Settings?.Clone()), Logger);
        }
    ...
    public abstract partial class AdGroupAssetServiceClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(AdGroupAssetService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
        ...
        /// <returns>The created <see cref="AdGroupAssetServiceClient"/>.</returns>
        internal static AdGroupAssetServiceClient Create(grpccore::CallInvoker callInvoker, AdGroupAssetServiceSettings settings = null, mel::ILogger logger = null)
        {
            ...
            return new AdGroupAssetServiceClientImpl(grpcClient, settings, logger);
        }
    ...
    public sealed partial class AdGroupAssetServiceClientImpl : AdGroupAssetServiceClient
    {
        ...
        public AdGroupAssetServiceClientImpl(AdGroupAssetService.AdGroupAssetServiceClient grpcClient, AdGroupAssetServiceSettings settings, mel::ILogger logger)
        {
            ...
            _callMutateAdGroupAssets = clientHelper.BuildApiCall<MutateAdGroupAssetsRequest, MutateAdGroupAssetsResponse>("MutateAdGroupAssets", grpcClient.MutateAdGroupAssetsAsync, grpcClient.MutateAdGroupAssets, effectiveSettings.MutateAdGroupAssetsSettings).WithGoogleRequestParam("customer_id", request => request.CustomerId);
