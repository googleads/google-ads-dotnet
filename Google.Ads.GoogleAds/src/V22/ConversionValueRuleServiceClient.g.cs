...
namespace Google.Ads.GoogleAds.V22.Services
{
    ...
    internal sealed partial class ConversionValueRuleServiceClientBuilder : gaxgrpc::ClientBuilderBase<ConversionValueRuleServiceClient>
    {
        ...
        public ConversionValueRuleServiceClientBuilder() : base(ConversionValueRuleServiceClient.ServiceMetadata)
        {
        }
        ...
        private ConversionValueRuleServiceClient BuildImpl()
        {
            ...
            return ConversionValueRuleServiceClient.Create(callInvoker, GetEffectiveSettings(Settings?.Clone()), Logger);
        }
    ...
    public abstract partial class ConversionValueRuleServiceClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(ConversionValueRuleService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
        ...
        /// <returns>The created <see cref="ConversionValueRuleServiceClient"/>.</returns>
        internal static ConversionValueRuleServiceClient Create(grpccore::CallInvoker callInvoker, ConversionValueRuleServiceSettings settings = null, mel::ILogger logger = null)
        {
            ...
            return new ConversionValueRuleServiceClientImpl(grpcClient, settings, logger);
        }
    ...
    public sealed partial class ConversionValueRuleServiceClientImpl : ConversionValueRuleServiceClient
    {
        ...
        public ConversionValueRuleServiceClientImpl(ConversionValueRuleService.ConversionValueRuleServiceClient grpcClient, ConversionValueRuleServiceSettings settings, mel::ILogger logger)
        {
            ...
            _callMutateConversionValueRules = clientHelper.BuildApiCall<MutateConversionValueRulesRequest, MutateConversionValueRulesResponse>("MutateConversionValueRules", grpcClient.MutateConversionValueRulesAsync, grpcClient.MutateConversionValueRules, effectiveSettings.MutateConversionValueRulesSettings).WithGoogleRequestParam("customer_id", request => request.CustomerId);
