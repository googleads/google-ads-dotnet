...
namespace Google.Ads.GoogleAds.V22.Services
{
    ...
    public sealed partial class GoogleAdsServiceClientImpl : GoogleAdsServiceClient
    {
        ...
        public override gax::PagedEnumerable<SearchGoogleAdsResponse, GoogleAdsRow> Search(SearchGoogleAdsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            ...
            return new gaxgrpc::AdsPagedEnumerable<SearchGoogleAdsRequest, SearchGoogleAdsResponse, GoogleAdsRow>(_callSearch, request, callSettings);
        }
        ...
        {
            Modify_SearchGoogleAdsRequest(ref request, ref callSettings);
            return new gaxgrpc::AdsPagedAsyncEnumerable<SearchGoogleAdsRequest, SearchGoogleAdsResponse, GoogleAdsRow>(_callSearch, request, callSettings);
        }
