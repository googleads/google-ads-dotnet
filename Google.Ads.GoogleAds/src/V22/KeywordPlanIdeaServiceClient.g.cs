...
namespace Google.Ads.GoogleAds.V22.Services
{
    ...
    internal sealed partial class KeywordPlanIdeaServiceClientBuilder : gaxgrpc::ClientBuilderBase<KeywordPlanIdeaServiceClient>
    {
        ...
        private KeywordPlanIdeaServiceClient BuildImpl()
        {
            ...
            return KeywordPlanIdeaServiceClient.Create(callInvoker, GetEffectiveSettings(Settings?.Clone()), Logger);
        }
    ...
    public abstract partial class KeywordPlanIdeaServiceClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual GenerateAdGroupThemesResponse GenerateAdGroupThemes(string customerId, scg::IEnumerable<string> keywords, scg::IEnumerable<string> adGroups, gaxgrpc::CallSettings callSettings = null) =>
            GenerateAdGroupThemes(new GenerateAdGroupThemesRequest
            {
                CustomerId = gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)),
                Keywords =
                {
                    gax::GaxPreconditions.CheckNotNull(keywords, nameof(keywords)),
                },
                AdGroups =
                {
                    gax::GaxPreconditions.CheckNotNull(adGroups, nameof(adGroups)),
                },
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<GenerateAdGroupThemesResponse> GenerateAdGroupThemesAsync(string customerId, scg::IEnumerable<string> keywords, scg::IEnumerable<string> adGroups, gaxgrpc::CallSettings callSettings = null) =>
            GenerateAdGroupThemesAsync(new GenerateAdGroupThemesRequest
            {
                CustomerId = gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)),
                Keywords =
                {
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<GenerateAdGroupThemesResponse> GenerateAdGroupThemesAsync(string customerId, scg::IEnumerable<string> keywords, scg::IEnumerable<string> adGroups, st::CancellationToken cancellationToken) =>
            GenerateAdGroupThemesAsync(customerId, keywords, adGroups, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual GenerateKeywordForecastMetricsResponse GenerateKeywordForecastMetrics(CampaignToForecast campaign, gaxgrpc::CallSettings callSettings = null) =>
            GenerateKeywordForecastMetrics(new GenerateKeywordForecastMetricsRequest
            {
                Campaign = gax::GaxPreconditions.CheckNotNull(campaign, nameof(campaign)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<GenerateKeywordForecastMetricsResponse> GenerateKeywordForecastMetricsAsync(CampaignToForecast campaign, gaxgrpc::CallSettings callSettings = null) =>
            GenerateKeywordForecastMetricsAsync(new GenerateKeywordForecastMetricsRequest
            {
                Campaign = gax::GaxPreconditions.CheckNotNull(campaign, nameof(campaign)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<GenerateKeywordForecastMetricsResponse> GenerateKeywordForecastMetricsAsync(CampaignToForecast campaign, st::CancellationToken cancellationToken) =>
            GenerateKeywordForecastMetricsAsync(campaign, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
    }
    ...
    public sealed partial class KeywordPlanIdeaServiceClientImpl : KeywordPlanIdeaServiceClient
    {
        ...
        public override gax::PagedEnumerable<GenerateKeywordIdeaResponse, GenerateKeywordIdeaResult> GenerateKeywordIdeas(GenerateKeywordIdeasRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            ...
            return new gaxgrpc::AdsPagedEnumerable<GenerateKeywordIdeasRequest, GenerateKeywordIdeaResponse, GenerateKeywordIdeaResult>(_callGenerateKeywordIdeas, request, callSettings);
        }
        ...
        {
            Modify_GenerateKeywordIdeasRequest(ref request, ref callSettings);
            return new gaxgrpc::AdsPagedAsyncEnumerable<GenerateKeywordIdeasRequest, GenerateKeywordIdeaResponse, GenerateKeywordIdeaResult>(_callGenerateKeywordIdeas, request, callSettings);
        }
