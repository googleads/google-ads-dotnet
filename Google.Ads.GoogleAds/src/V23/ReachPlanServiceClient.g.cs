...
namespace Google.Ads.GoogleAds.V23.Services
{
    ...
    public sealed partial class ReachPlanServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        private ReachPlanServiceSettings(ReachPlanServiceSettings existing) : base(existing)
        {
            ...
            ListPlannableUserInterestsSettings = existing.ListPlannableUserInterestsSettings;
            OnCopy(existing);
        }
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>ReachPlanServiceClient.ListPlannableUserInterests</c> and
        /// <c>ReachPlanServiceClient.ListPlannableUserInterestsAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>Initial retry delay: 5000 milliseconds.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings ListPlannableUserInterestsSettings { get; set; } = gaxgrpc::CallSettingsExtensions.WithRetry(gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(14400000))), gaxgrpc::RetrySettings.FromExponentialBackoff(maxAttempts: 2147483647, initialBackoff: sys::TimeSpan.FromMilliseconds(5000), maxBackoff: sys::TimeSpan.FromMilliseconds(60000), backoffMultiplier: 1.3, retryFilter: gaxgrpc::RetrySettings.FilterForStatusCodes(grpccore::StatusCode.Unavailable, grpccore::StatusCode.DeadlineExceeded)));
    ...
    public abstract partial class ReachPlanServiceClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual ListPlannableUserInterestsResponse ListPlannableUserInterests(ListPlannableUserInterestsRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ListPlannableUserInterestsResponse> ListPlannableUserInterestsAsync(ListPlannableUserInterestsRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ListPlannableUserInterestsResponse> ListPlannableUserInterestsAsync(ListPlannableUserInterestsRequest request, st::CancellationToken cancellationToken) =>
            ListPlannableUserInterestsAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual ListPlannableUserInterestsResponse ListPlannableUserInterests(string customerId, gaxgrpc::CallSettings callSettings = null) =>
            ListPlannableUserInterests(new ListPlannableUserInterestsRequest
            {
                CustomerId = gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ListPlannableUserInterestsResponse> ListPlannableUserInterestsAsync(string customerId, gaxgrpc::CallSettings callSettings = null) =>
            ListPlannableUserInterestsAsync(new ListPlannableUserInterestsRequest
            {
                CustomerId = gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ListPlannableUserInterestsResponse> ListPlannableUserInterestsAsync(string customerId, st::CancellationToken cancellationToken) =>
            ListPlannableUserInterestsAsync(customerId, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
    }
    ...
    public sealed partial class ReachPlanServiceClientImpl : ReachPlanServiceClient
    {
        ...
        private readonly gaxgrpc::ApiCall<ListPlannableUserInterestsRequest, ListPlannableUserInterestsResponse> _callListPlannableUserInterests;
        ...
        public ReachPlanServiceClientImpl(ReachPlanService.ReachPlanServiceClient grpcClient, ReachPlanServiceSettings settings, mel::ILogger logger)
        {
            ...
            _callListPlannableUserInterests = clientHelper.BuildApiCall<ListPlannableUserInterestsRequest, ListPlannableUserInterestsResponse>("ListPlannableUserInterests", grpcClient.ListPlannableUserInterestsAsync, grpcClient.ListPlannableUserInterests, effectiveSettings.ListPlannableUserInterestsSettings);
            Modify_ApiCall(ref _callListPlannableUserInterests);
            Modify_ListPlannableUserInterestsApiCall(ref _callListPlannableUserInterests);
        ...
        partial void Modify_ListPlannableUserInterestsApiCall(ref gaxgrpc::ApiCall<ListPlannableUserInterestsRequest, ListPlannableUserInterestsResponse> call);
        ...
        partial void Modify_ListPlannableUserInterestsRequest(ref ListPlannableUserInterestsRequest request, ref gaxgrpc::CallSettings settings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override ListPlannableUserInterestsResponse ListPlannableUserInterests(ListPlannableUserInterestsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_ListPlannableUserInterestsRequest(ref request, ref callSettings);
            return _callListPlannableUserInterests.Sync(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task<ListPlannableUserInterestsResponse> ListPlannableUserInterestsAsync(ListPlannableUserInterestsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_ListPlannableUserInterestsRequest(ref request, ref callSettings);
            return _callListPlannableUserInterests.Async(request, callSettings);
        }
    }
}
