...
using gagvs = Google.Ads.GoogleAds.V23.Services;
...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static partial class ServiceCollectionExtensions
    {
        ...
        /// <summary>
        /// Adds a singleton <see cref="gagvs::BenchmarksServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        internal static IServiceCollection AddBenchmarksServiceClient(this IServiceCollection services, sys::Action<gagvs::BenchmarksServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gagvs::BenchmarksServiceClientBuilder builder = new gagvs::BenchmarksServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        internal static IServiceCollection AddBenchmarksServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gagvs::BenchmarksServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gagvs::BenchmarksServiceClientBuilder builder = new gagvs::BenchmarksServiceClientBuilder();
                action?.Invoke(provider, builder);
        ...
        /// <summary>
        /// Adds a singleton <see cref="gagvs::IncentiveServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        internal static IServiceCollection AddIncentiveServiceClient(this IServiceCollection services, sys::Action<gagvs::IncentiveServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gagvs::IncentiveServiceClientBuilder builder = new gagvs::IncentiveServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        internal static IServiceCollection AddIncentiveServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gagvs::IncentiveServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gagvs::IncentiveServiceClientBuilder builder = new gagvs::IncentiveServiceClientBuilder();
                action?.Invoke(provider, builder);
