...
namespace Google.Ads.GoogleAds.V24.Resources
{
    ...
    public partial class AccountBudget
    {
        ...
        {
            public partial class PendingAccountBudgetProposal
            {
                /// <summary>
                /// <see cref="AccountBudgetProposalName"/>-typed view over the <see cref="AccountBudgetProposal"/>
                /// resource name property.
                /// </summary>
                internal AccountBudgetProposalName AccountBudgetProposalAsAccountBudgetProposalName
                {
                    get => string.IsNullOrEmpty(AccountBudgetProposal) ? null : AccountBudgetProposalName.Parse(AccountBudgetProposal, allowUnparsed: true);
                    set => AccountBudgetProposal = value?.ToString() ?? "";
                }
            }
        }
    }
