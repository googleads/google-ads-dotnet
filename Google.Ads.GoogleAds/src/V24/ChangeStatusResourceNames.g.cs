...
namespace Google.Ads.GoogleAds.V24.Resources
{
    ...
    public partial class ChangeStatus
    {
        ...
        /// <summary>
        /// <see cref="CampaignAssetSetName"/>-typed view over the <see cref="CampaignAssetSet"/> resource name
        /// property.
        /// </summary>
        internal CampaignAssetSetName CampaignAssetSetAsCampaignAssetSetName
        {
            get => string.IsNullOrEmpty(CampaignAssetSet) ? null : CampaignAssetSetName.Parse(CampaignAssetSet, allowUnparsed: true);
            set => CampaignAssetSet = value?.ToString() ?? "";
        }
    }
}
