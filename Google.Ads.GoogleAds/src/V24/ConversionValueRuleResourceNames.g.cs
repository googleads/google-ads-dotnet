...
namespace Google.Ads.GoogleAds.V24.Resources
{
    ...
    public partial class ConversionValueRule
    {
        ...
        {
            public partial class ValueRuleGeoLocationCondition
            {
                /// <summary>
                /// <see cref="GeoTargetConstantName"/>-typed view over the <see cref="ExcludedGeoTargetConstants"/>
                /// resource name property.
                /// </summary>
                internal gax::ResourceNameList<GeoTargetConstantName> ExcludedGeoTargetConstantsAsGeoTargetConstantNames
                {
                    get => new gax::ResourceNameList<GeoTargetConstantName>(ExcludedGeoTargetConstants, s => string.IsNullOrEmpty(s) ? null : GeoTargetConstantName.Parse(s, allowUnparsed: true));
                }

                /// <summary>
                /// <see cref="GeoTargetConstantName"/>-typed view over the <see cref="GeoTargetConstants"/> resource
                /// name property.
                /// </summary>
                internal gax::ResourceNameList<GeoTargetConstantName> GeoTargetConstantsAsGeoTargetConstantNames
                {
                    get => new gax::ResourceNameList<GeoTargetConstantName>(GeoTargetConstants, s => string.IsNullOrEmpty(s) ? null : GeoTargetConstantName.Parse(s, allowUnparsed: true));
                }
            }

            public partial class ValueRuleAudienceCondition
            {
                /// <summary>
                /// <see cref="UserListName"/>-typed view over the <see cref="UserLists"/> resource name property.
                /// </summary>
                internal gax::ResourceNameList<UserListName> UserListsAsUserListNames
                {
                    get => new gax::ResourceNameList<UserListName>(UserLists, s => string.IsNullOrEmpty(s) ? null : UserListName.Parse(s, allowUnparsed: true));
                }

                /// <summary>
                /// <see cref="UserInterestName"/>-typed view over the <see cref="UserInterests"/> resource name
                /// property.
                /// </summary>
                internal gax::ResourceNameList<UserInterestName> UserInterestsAsUserInterestNames
                {
                    get => new gax::ResourceNameList<UserInterestName>(UserInterests, s => string.IsNullOrEmpty(s) ? null : UserInterestName.Parse(s, allowUnparsed: true));
                }
            }
        }
    }
