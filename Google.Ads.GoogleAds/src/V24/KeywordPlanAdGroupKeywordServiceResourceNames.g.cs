...
namespace Google.Ads.GoogleAds.V24.Services
{
    public partial class KeywordPlanAdGroupKeywordOperation
    {
        ...
        /// property.
        /// </summary>
        internal gagvr::KeywordPlanAdGroupKeywordName RemoveAsKeywordPlanAdGroupKeywordName
        {
    ...
    public partial class MutateKeywordPlanAdGroupKeywordResult
    {
        /// <summary>
        /// <see cref="gagvr::KeywordPlanAdGroupKeywordName"/>-typed view over the <see cref="ResourceName"/> resource
        /// name property.
        /// </summary>
        internal gagvr::KeywordPlanAdGroupKeywordName ResourceNameAsKeywordPlanAdGroupKeywordName
        {
