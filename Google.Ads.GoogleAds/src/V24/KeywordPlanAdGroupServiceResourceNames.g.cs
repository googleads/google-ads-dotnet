...
namespace Google.Ads.GoogleAds.V24.Services
{
    public partial class KeywordPlanAdGroupOperation
    {
        ...
        /// </summary>
        internal gagvr::KeywordPlanAdGroupName RemoveAsKeywordPlanAdGroupName
        {
    ...
    public partial class MutateKeywordPlanAdGroupResult
    {
        /// <summary>
        /// <see cref="gagvr::KeywordPlanAdGroupName"/>-typed view over the <see cref="ResourceName"/> resource name
        /// property.
        /// </summary>
        internal gagvr::KeywordPlanAdGroupName ResourceNameAsKeywordPlanAdGroupName
        {
