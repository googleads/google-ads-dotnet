...
namespace Google.Ads.GoogleAds.V24.Services
{
    ...
    public abstract partial class ShareablePreviewServiceClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual GenerateShareablePreviewsResponse GenerateShareablePreviews(string customerId, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<GenerateShareablePreviewsResponse> GenerateShareablePreviewsAsync(string customerId, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<GenerateShareablePreviewsResponse> GenerateShareablePreviewsAsync(string customerId, st::CancellationToken cancellationToken) =>
            GenerateShareablePreviewsAsync(customerId, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
    }
