...
namespace Google.Ads.GoogleAds.V25.Services
{
    ...
    public abstract partial class IncentiveServiceClient
    {
        ...
        /// Applies the incentive for the ads customer.
        /// </summary>
        /// <param name="selectedIncentiveId">
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual ApplyIncentiveResponse ApplyIncentive(long selectedIncentiveId, string customerId, string countryCode, gaxgrpc::CallSettings callSettings = null) =>
            ApplyIncentive(new ApplyIncentiveRequest
            {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ApplyIncentiveResponse> ApplyIncentiveAsync(long selectedIncentiveId, string customerId, string countryCode, gaxgrpc::CallSettings callSettings = null) =>
            ApplyIncentiveAsync(new ApplyIncentiveRequest
            {
                SelectedIncentiveId = selectedIncentiveId,
                CustomerId = gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ApplyIncentiveResponse> ApplyIncentiveAsync(long selectedIncentiveId, string customerId, string countryCode, st::CancellationToken cancellationToken) =>
            ApplyIncentiveAsync(selectedIncentiveId, customerId, countryCode, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
    }
