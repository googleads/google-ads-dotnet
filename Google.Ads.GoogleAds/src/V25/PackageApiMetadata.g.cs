...
namespace Google.Ads.GoogleAds.V25.Services
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Ads.GoogleAds.V25.Services", GetFileDescriptors)
            .WithHttpRuleOverrides(new scg::Dictionary<string, proto::ByteString>
            {
                {
                    "google.longrunning.Operations.CancelOperation",
                    // { "post": "/v25/{name=customers/*/operations/*}:cancel", "body": "*" }
                    proto::ByteString.FromBase64("IisvdjI1L3tuYW1lPWN1c3RvbWVycy8qL29wZXJhdGlvbnMvKn06Y2FuY2VsOgEq")
                },
                {
                    "google.longrunning.Operations.DeleteOperation",
                    // { "delete": "/v25/{name=customers/*/operations/*}" }
                    proto::ByteString.FromBase64("KiQvdjI1L3tuYW1lPWN1c3RvbWVycy8qL29wZXJhdGlvbnMvKn0=")
                },
                {
                    "google.longrunning.Operations.GetOperation",
                    // { "get": "/v25/{name=customers/*/operations/*}" }
                    proto::ByteString.FromBase64("EiQvdjI1L3tuYW1lPWN1c3RvbWVycy8qL29wZXJhdGlvbnMvKn0=")
                },
                {
                    "google.longrunning.Operations.ListOperations",
                    // { "get": "/v25/{name=customers/*/operations}" }
                    proto::ByteString.FromBase64("EiIvdjI1L3tuYW1lPWN1c3RvbWVycy8qL29wZXJhdGlvbnN9")
                },
                {
                    "google.longrunning.Operations.WaitOperation",
                    // { "post": "/v25/{name=customers/*/operations/*}:wait", "body": "*" }
                    proto::ByteString.FromBase64("IikvdjI1L3tuYW1lPWN1c3RvbWVycy8qL29wZXJhdGlvbnMvKn06d2FpdDoBKg==")
                },
            });
