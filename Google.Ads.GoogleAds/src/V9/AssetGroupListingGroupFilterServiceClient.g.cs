...
namespace Google.Ads.GoogleAds.V9.Services
{
    ...
    internal sealed partial class AssetGroupListingGroupFilterServiceClientBuilder : gaxgrpc::ClientBuilderBase<AssetGroupListingGroupFilterServiceClient>
    {
        ...
        public AssetGroupListingGroupFilterServiceClientBuilder()
        {
            UseJwtAccessWithScopes = AssetGroupListingGroupFilterServiceClient.UseJwtAccessWithScopes;
        }
        ...
        private AssetGroupListingGroupFilterServiceClient BuildImpl()
        {
            ...
            return AssetGroupListingGroupFilterServiceClient.Create(callInvoker, Settings);
        }
        ...
        protected override string GetDefaultEndpoint() => AssetGroupListingGroupFilterServiceClient.DefaultEndpoint;

        /// <summary>
        /// Returns the default scopes for this builder type, used if no scopes are otherwise specified.
        /// </summary>
        protected override scg::IReadOnlyList<string> GetDefaultScopes() =>
            AssetGroupListingGroupFilterServiceClient.DefaultScopes;
    ...
    public abstract partial class AssetGroupListingGroupFilterServiceClient
    {
        ...
        /// <returns>The created <see cref="AssetGroupListingGroupFilterServiceClient"/>.</returns>
        internal static AssetGroupListingGroupFilterServiceClient Create(grpccore::CallInvoker callInvoker, AssetGroupListingGroupFilterServiceSettings settings = null)
        {
            ...
            return new AssetGroupListingGroupFilterServiceClientImpl(grpcClient, settings);
        }
