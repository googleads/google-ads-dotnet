...
namespace Google.Ads.GoogleAds.V9.Services
{
    ...
    public sealed partial class CustomInterestServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetCustomInterestSettings { get; set; } = gaxgrpc::CallSettingsExtensions.WithRetry(gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(14400000))), gaxgrpc::RetrySettings.FromExponentialBackoff(maxAttempts: 2147483647, initialBackoff: sys::TimeSpan.FromMilliseconds(5000), maxBackoff: sys::TimeSpan.FromMilliseconds(60000), backoffMultiplier: 1.3, retryFilter: gaxgrpc::RetrySettings.FilterForStatusCodes(grpccore::StatusCode.Unavailable, grpccore::StatusCode.DeadlineExceeded)));
    ...
    internal sealed partial class CustomInterestServiceClientBuilder : gaxgrpc::ClientBuilderBase<CustomInterestServiceClient>
    {
        ...
        public CustomInterestServiceClientBuilder()
        {
            UseJwtAccessWithScopes = CustomInterestServiceClient.UseJwtAccessWithScopes;
        }
