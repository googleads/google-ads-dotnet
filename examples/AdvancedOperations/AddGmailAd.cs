...
using static Google.Ads.GoogleAds.V1.Enums.DeviceEnum.Types;
using static Google.Ads.GoogleAds.V1.Enums.MediaTypeEnum.Types;
using static Google.Ads.GoogleAds.V1.Enums.MimeTypeEnum.Types;
    ...
    public class AddGmailAd : ExampleBase
    {
        ...
        private Dictionary<string, string> AddMediaFiles(GoogleAdsClient client, long customerId)
        {
            ...
            MediaFileServiceClient mediaFileService =
                client.GetService(Services.V1.MediaFileService);
            ...
            Dictionary<string, string> mediaFiles)
        {
            ...
            {
                Ad = ad,
                Status = GoogleAds.V1.Enums.AdGroupAdStatusEnum.Types.AdGroupAdStatus.Paused,
