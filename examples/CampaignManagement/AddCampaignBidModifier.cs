...
using static Google.Ads.GoogleAds.V9.Enums.InteractionTypeEnum.Types;
using static Google.Ads.GoogleAds.V9.Enums.ResponseContentTypeEnum.Types;
    ...
    public class AddCampaignBidModifier : ExampleBase
    {
            ...
            double bidModifierValue)
        {
            ...
            CampaignBidModifierServiceClient campaignBidModifierService =
                client.GetService(Services.V9.CampaignBidModifierService);
