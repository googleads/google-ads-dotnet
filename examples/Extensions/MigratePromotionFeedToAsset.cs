...
namespace Google.Ads.GoogleAds.Examples.V8
{
    ...
    public class MigratePromotionFeedToAsset : ExampleBase
    {
            ...
            string promotionAssetResourceName, List<long> campaignIds)
        {
            ...
            CampaignAssetServiceClient campaignAssetServiceClient = client.GetService(Services.V8
            ...
            string promotionAssetResourceName, List<long> adGroupIds)
        {
            ...
            AdGroupAssetServiceClient adGroupAssetServiceClient = client.GetService(Services.V8
                .AdGroupAssetService);
