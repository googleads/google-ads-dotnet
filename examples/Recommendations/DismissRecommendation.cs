...
using System;
using static Google.Ads.GoogleAds.V4.Services.DismissRecommendationRequest.Types;
using static Google.Ads.GoogleAds.V4.Services.DismissRecommendationResponse.Types;
