...
using System;
using static Google.Ads.GoogleAds.V5.Services.DismissRecommendationRequest.Types;
using static Google.Ads.GoogleAds.V5.Services.DismissRecommendationResponse.Types;
