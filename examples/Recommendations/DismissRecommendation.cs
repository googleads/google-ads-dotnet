...
using System;
using static Google.Ads.GoogleAds.V1.Services.DismissRecommendationRequest.Types;
using static Google.Ads.GoogleAds.V1.Services.DismissRecommendationResponse.Types;
