...
using System.Linq;
using static Google.Ads.GoogleAds.V8.Enums.CustomAudienceMemberTypeEnum.Types;
using static Google.Ads.GoogleAds.V8.Enums.CustomAudienceStatusEnum.Types;
using static Google.Ads.GoogleAds.V8.Enums.CustomAudienceTypeEnum.Types;
    ...
    public class AddCustomAudience : ExampleBase
    {
        ...
        public void Run(GoogleAdsClient client, long customerId)
        {
            ...
            CustomAudienceServiceClient customAudienceServiceClient =
                client.GetService(Services.V8.CustomAudienceService);
