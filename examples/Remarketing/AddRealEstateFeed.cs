...
using static Google.Ads.GoogleAds.V3.Enums.RealEstatePlaceholderFieldEnum.Types;
...
namespace Google.Ads.GoogleAds.Examples.V3
{
    ...
    public class AddRealEstateFeed : ExampleBase
    {
        ...
        public override string Description
        {
            get
            {
                return "This code example adds a real estate feed, creates the feed mapping, " +
                    "and adds items to the feed. To update feeds, see " +
            ...
            GoogleAdsClient client, long customerId, string feedResourceName)
        {
            ...
            foreach (FeedAttribute feedAttribute in googleAdsRow.Feed.Attributes)
            {
                switch (feedAttribute.Name)
                {
                    ...
                    // https://developers.google.com/google-ads/api/reference/rpc/Google.Ads.GoogleAds.V3.enums#RealEstatePlaceholderFieldenum.
                    default:
