...
using static Google.Ads.GoogleAds.V4.Enums.OfflineUserDataJobStatusEnum.Types;
...
namespace Google.Ads.GoogleAds.Examples.V4
{
    ...
    public class UploadStoreSalesTransactions : ExampleBase
    {
        ...
        public static void Main(string[] args)
        {
            ...
            // OPTIONAL: If uploading data with custom key and values, also specify the following value if not passed as an arg:
