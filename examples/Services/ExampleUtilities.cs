...
namespace Google.Ads.GoogleAds.Examples {
  ...
  public class ExampleUtilities {
    ...
    public static bool IsNullable(SystemType type) {
    ...
    public static SystemType GetUnderlyingType(SystemType type) {
    ...
    public static List<object> GetParameters(MethodInfo methodInfo) {
      ...
      for (int i = 1; i < paramInfos.Length; i++) {
        ...
        SystemType underlyingType = GetUnderlyingType(paramInfo.ParameterType);
