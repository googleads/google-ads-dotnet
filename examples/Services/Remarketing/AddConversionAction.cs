...
using System;
using static Google.Ads.GoogleAds.V0.Enums.ConversionActionCategoryEnum.Types;
using static Google.Ads.GoogleAds.V0.Enums.ConversionActionStatusEnum.Types;
using static Google.Ads.GoogleAds.V0.Enums.ConversionActionTypeEnum.Types;
    ...
    public class AddConversionAction : ExampleBase
    {
        ...
        public void Run(GoogleAdsClient client, long customerId)
        {
            ...
            ConversionActionServiceClient conversionActionService =
                client.GetService(Services.V0.ConversionActionService);
