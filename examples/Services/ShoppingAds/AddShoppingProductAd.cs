...
using System;
using static Google.Ads.GoogleAds.V0.Enums.AdGroupAdStatusEnum.Types;
using static Google.Ads.GoogleAds.V0.Enums.AdGroupCriterionStatusEnum.Types;
using static Google.Ads.GoogleAds.V0.Enums.AdGroupStatusEnum.Types;
using static Google.Ads.GoogleAds.V0.Enums.AdGroupTypeEnum.Types;
...
using static Google.Ads.GoogleAds.V0.Enums.ListingGroupTypeEnum.Types;
    ...
    public class AddShoppingProductAd : ExampleBase
    {
        ...
        private string AddCampaignBudget(GoogleAdsClient client, long customerId)
        {
            ...
            CampaignBudgetServiceClient campaignBudgetService =
                client.GetService(Services.V0.CampaignBudgetService);
