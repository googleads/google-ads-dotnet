...
namespace Google.Ads.GoogleAds.V0.Services {
  ...
  public sealed partial class AdGroupCriterionServiceSettings : gaxgrpc::ServiceSettingsBase {
    ...
    /// </remarks>
    public gaxgrpc::CallSettings GetAdGroupCriterionSettings {
      get; set;
    ...
    /// Default RPC expiration is 600000 milliseconds.
    /// </remarks>
    public gaxgrpc::CallSettings MutateAdGroupCriteriaSettings {
      get; set;
    } = gaxgrpc::CallSettings.FromCallTiming(
        gaxgrpc::CallTiming.FromRetry(new gaxgrpc::RetrySettings(
            retryBackoff: GetDefaultRetryBackoff(),
  ...
  public abstract partial class AdGroupCriterionServiceClient {
    ...
    public virtual stt::Task<gagvr::AdGroupCriterion> GetAdGroupCriterionAsync(
        ...
        gaxgrpc::CallSettings callSettings = null) => GetAdGroupCriterionAsync(
            new gagvs::GetAdGroupCriterionRequest {
    ...
    /// </returns>
    public virtual stt::Task<gagvr::AdGroupCriterion> GetAdGroupCriterionAsync(
        gagvs::GetAdGroupCriterionRequest request,
    ...
    /// A Task containing the RPC response.
    /// </returns>
    public virtual stt::Task<gagvs::MutateAdGroupCriteriaResponse> MutateAdGroupCriteriaAsync(
        string customerId,
        scg::IEnumerable<gagvs::AdGroupCriterionOperation> operations,
        gaxgrpc::CallSettings callSettings = null) => MutateAdGroupCriteriaAsync(
            new gagvs::MutateAdGroupCriteriaRequest {
    ...
    /// The RPC response.
    /// </returns>
    public virtual gagvs::MutateAdGroupCriteriaResponse MutateAdGroupCriteria(
        string customerId,
        scg::IEnumerable<gagvs::AdGroupCriterionOperation> operations,
    ...
    /// </returns>
    public virtual stt::Task<gagvs::MutateAdGroupCriteriaResponse> MutateAdGroupCriteriaAsync(
        gagvs::MutateAdGroupCriteriaRequest request,
        gaxgrpc::CallSettings callSettings = null) {
      throw new sys::NotImplementedException();
    }
  ...
  public sealed partial class AdGroupCriterionServiceClientImpl : AdGroupCriterionServiceClient {
    private readonly gaxgrpc::ApiCall<gagvs::GetAdGroupCriterionRequest, gagvr::AdGroupCriterion> _callGetAdGroupCriterion;
    private readonly gaxgrpc::ApiCall<gagvs::MutateAdGroupCriteriaRequest, gagvs::MutateAdGroupCriteriaResponse> _callMutateAdGroupCriteria;
    ...
    public AdGroupCriterionServiceClientImpl(AdGroupCriterionService.AdGroupCriterionServiceClient grpcClient, AdGroupCriterionServiceSettings settings) {
      ...
      _callGetAdGroupCriterion = clientHelper.BuildApiCall<gagvs::GetAdGroupCriterionRequest, gagvr::AdGroupCriterion>(
          GrpcClient.GetAdGroupCriterionAsync, GrpcClient.GetAdGroupCriterion, effectiveSettings.GetAdGroupCriterionSettings);
      _callMutateAdGroupCriteria = clientHelper.BuildApiCall<gagvs::MutateAdGroupCriteriaRequest, gagvs::MutateAdGroupCriteriaResponse>(
    ...
    partial void Modify_GetAdGroupCriterionApiCall(ref gaxgrpc::ApiCall<gagvs::GetAdGroupCriterionRequest, gagvr::AdGroupCriterion> call);

    partial void Modify_MutateAdGroupCriteriaApiCall(ref gaxgrpc::ApiCall<gagvs::MutateAdGroupCriteriaRequest, gagvs::MutateAdGroupCriteriaResponse> call);
    ...
    partial void Modify_GetAdGroupCriterionRequest(ref gagvs::GetAdGroupCriterionRequest request, ref gaxgrpc::CallSettings settings);

    partial void Modify_MutateAdGroupCriteriaRequest(ref gagvs::MutateAdGroupCriteriaRequest request, ref gaxgrpc::CallSettings settings);
    ...
    /// A Task containing the RPC response.
    /// </returns>
    public override stt::Task<gagvs::MutateAdGroupCriteriaResponse> MutateAdGroupCriteriaAsync(
        gagvs::MutateAdGroupCriteriaRequest request,
        gaxgrpc::CallSettings callSettings = null) {
    ...
    /// The RPC response.
    /// </returns>
    public override gagvs::MutateAdGroupCriteriaResponse MutateAdGroupCriteria(
        gagvs::MutateAdGroupCriteriaRequest request,
        gaxgrpc::CallSettings callSettings = null) {
      Modify_MutateAdGroupCriteriaRequest(ref request, ref callSettings);
