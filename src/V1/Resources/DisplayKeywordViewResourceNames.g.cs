...
namespace Google.Ads.GoogleAds.V1.Resources
{
    ...
    public sealed partial class DisplayKeywordViewName : gax::IResourceName, sys::IEquatable<DisplayKeywordViewName>
    {
        ...
        /// <c>customers/{customer}/displayKeywordViews/{display_keyword_view}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="displayKeywordViewId">
        /// The <c>DisplayKeywordView</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        /// <returns>A new instance of <see cref="DisplayKeywordViewName"/> constructed from the provided ids.</returns>
        public static DisplayKeywordViewName FromCustomerDisplayKeywordView(string customerId, string displayKeywordViewId) =>
            new DisplayKeywordViewName(ResourceNameType.CustomerDisplayKeywordView, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), displayKeywordViewId: gax::GaxPreconditions.CheckNotNullOrEmpty(displayKeywordViewId, nameof(displayKeywordViewId)));
        ...
        public static string Format(string customerId, string displayKeywordViewId) =>
            FormatCustomerDisplayKeywordView(customerId, displayKeywordViewId);
        ...
        /// <c>customers/{customer}/displayKeywordViews/{display_keyword_view}</c>.
        /// </returns>
        public static string FormatCustomerDisplayKeywordView(string customerId, string displayKeywordViewId) =>
            s_customerDisplayKeywordView.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), gax::GaxPreconditions.CheckNotNullOrEmpty(displayKeywordViewId, nameof(displayKeywordViewId)));
        ...
        /// <list type="bullet">
        /// <item>
        /// <description><c>customers/{customer}/displayKeywordViews/{display_keyword_view}</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string displayKeywordViewName, bool allowUnparsed, out DisplayKeywordViewName result)
        {
            ...
            if (s_customerDisplayKeywordView.TryParseName(displayKeywordViewName, out resourceName))
            {
                result = FromCustomerDisplayKeywordView(resourceName[0], resourceName[1]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private DisplayKeywordViewName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string customerId = null, string displayKeywordViewId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            CustomerId = customerId;
            DisplayKeywordViewId = displayKeywordViewId;
        }

        /// <summary>
        /// Constructs a new instance of a <see cref="DisplayKeywordViewName"/> class from the component parts of
        /// pattern <c>customers/{customer}/displayKeywordViews/{display_keyword_view}</c>
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="displayKeywordViewId">
        /// The <c>DisplayKeywordView</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        public DisplayKeywordViewName(string customerId, string displayKeywordViewId) : this(ResourceNameType.CustomerDisplayKeywordView, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), displayKeywordViewId: gax::GaxPreconditions.CheckNotNullOrEmpty(displayKeywordViewId, nameof(displayKeywordViewId)))
        {
        }
        ...
        /// <summary>
        /// The <c>DisplayKeywordView</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed
        /// resource name.
        /// </summary>
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.CustomerDisplayKeywordView: return s_customerDisplayKeywordView.Expand(CustomerId, DisplayKeywordViewId);
