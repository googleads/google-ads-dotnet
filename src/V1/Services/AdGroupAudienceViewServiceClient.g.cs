...
namespace Google.Ads.GoogleAds.V1.Services
{
    ...
    public sealed partial class AdGroupAudienceViewServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetAdGroupAudienceViewSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class AdGroupAudienceViewServiceClient
    {
        ...
        /// <remarks>The default AdGroupAudienceViewService scopes are:<list type="bullet"></list></remarks>
