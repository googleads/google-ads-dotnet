...
namespace Google.Ads.GoogleAds.V1.Services
{
    ...
    public sealed partial class AdScheduleViewServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetAdScheduleViewSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class AdScheduleViewServiceClient
    {
        ...
        /// <remarks>The default AdScheduleViewService scopes are:<list type="bullet"></list></remarks>
