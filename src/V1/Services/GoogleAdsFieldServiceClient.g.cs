...
namespace Google.Ads.GoogleAds.V1.Services
{
    ...
    public sealed partial class GoogleAdsFieldServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetGoogleAdsFieldSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings SearchGoogleAdsFieldsSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class GoogleAdsFieldServiceClient
    {
        ...
        /// <remarks>The default GoogleAdsFieldService scopes are:<list type="bullet"></list></remarks>
