...
namespace Google.Ads.GoogleAds.V1.Services
{
    ...
    public sealed partial class LocationViewServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetLocationViewSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class LocationViewServiceClient
    {
        ...
        /// <remarks>The default LocationViewService scopes are:<list type="bullet"></list></remarks>
