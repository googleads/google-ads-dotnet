...
namespace Google.Ads.GoogleAds.V1.Resources {
    ...
    static MutateJobReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "bGVhZHMudjEucmVzb3VyY2VzLk11dGF0ZUpvYi5NdXRhdGVKb2JNZXRhZGF0",
            "YUID4EEDElcKBnN0YXR1cxgFIAEoDjJCLmdvb2dsZS5hZHMuZ29vZ2xlYWRz",
            "LnYxLmVudW1zLk11dGF0ZUpvYlN0YXR1c0VudW0uTXV0YXRlSm9iU3RhdHVz",
            ...
            "e211dGF0ZV9qb2J9QvsBCiVjb20uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjEu",
  ...
  public sealed partial class MutateJob : pb::IMessage<MutateJob> {
    ...
    private global::Google.Ads.GoogleAds.V1.Enums.MutateJobStatusEnum.Types.MutateJobStatus status_ = global::Google.Ads.GoogleAds.V1.Enums.MutateJobStatusEnum.Types.MutateJobStatus.Unspecified;
    /// <summary>
    ...
    public override int GetHashCode() {
      ...
      if (Status != global::Google.Ads.GoogleAds.V1.Enums.MutateJobStatusEnum.Types.MutateJobStatus.Unspecified) hash ^= Status.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (Status != global::Google.Ads.GoogleAds.V1.Enums.MutateJobStatusEnum.Types.MutateJobStatus.Unspecified) {
    ...
    public void MergeFrom(MutateJob other) {
      ...
      if (other.metadata_ != null) {
        if (metadata_ == null) {
          Metadata = new global::Google.Ads.GoogleAds.V1.Resources.MutateJob.Types.MutateJobMetadata();
        }
        Metadata.MergeFrom(other.Metadata);
      }
      if (other.Status != global::Google.Ads.GoogleAds.V1.Enums.MutateJobStatusEnum.Types.MutateJobStatus.Unspecified) {
        Status = other.Status;
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 40: {
            Status = (global::Google.Ads.GoogleAds.V1.Enums.MutateJobStatusEnum.Types.MutateJobStatus) input.ReadEnum();
            break;
          }
          case 50: {
