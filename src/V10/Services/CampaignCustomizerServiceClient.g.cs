...
namespace Google.Ads.GoogleAds.V10.Services
{
    ...
    internal sealed partial class CampaignCustomizerServiceClientBuilder : gaxgrpc::ClientBuilderBase<CampaignCustomizerServiceClient>
    {
        ...
        public CampaignCustomizerServiceClientBuilder()
        {
            UseJwtAccessWithScopes = CampaignCustomizerServiceClient.UseJwtAccessWithScopes;
        }
        ...
        private CampaignCustomizerServiceClient BuildImpl()
        {
            ...
            return CampaignCustomizerServiceClient.Create(callInvoker, Settings);
        }
        ...
        protected override string GetDefaultEndpoint() => CampaignCustomizerServiceClient.DefaultEndpoint;

        /// <summary>
        /// Returns the default scopes for this builder type, used if no scopes are otherwise specified.
        /// </summary>
        protected override scg::IReadOnlyList<string> GetDefaultScopes() => CampaignCustomizerServiceClient.DefaultScopes;
    ...
    public abstract partial class CampaignCustomizerServiceClient
    {
        ...
        /// <returns>The created <see cref="CampaignCustomizerServiceClient"/>.</returns>
        internal static CampaignCustomizerServiceClient Create(grpccore::CallInvoker callInvoker, CampaignCustomizerServiceSettings settings = null)
        {
            ...
            return new CampaignCustomizerServiceClientImpl(grpcClient, settings);
        }
    ...
    public sealed partial class CampaignCustomizerServiceClientImpl : CampaignCustomizerServiceClient
    {
        ...
        /// </param>
        public CampaignCustomizerServiceClientImpl(CampaignCustomizerService.CampaignCustomizerServiceClient grpcClient, CampaignCustomizerServiceSettings settings)
        {
