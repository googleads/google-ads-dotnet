...
using System;
using System.Text;
using static Google.Ads.GoogleAds.V2.Enums.ExtensionTypeEnum.Types;
using static Google.Ads.GoogleAds.V2.Enums.FeedItemTargetTypeEnum.Types;
using static Google.Ads.GoogleAds.V2.Enums.PlaceholderTypeEnum.Types;
using static Google.Ads.GoogleAds.V2.Enums.SimulationModificationMethodEnum.Types;
using static Google.Ads.GoogleAds.V2.Enums.SimulationTypeEnum.Types;
