...
namespace Google.Ads.GoogleAds.V2.Services
{
    ...
    public sealed partial class DistanceViewServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetDistanceViewSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class DistanceViewServiceClient
    {
        ...
        /// <remarks>The default DistanceViewService scopes are:<list type="bullet"></list></remarks>
