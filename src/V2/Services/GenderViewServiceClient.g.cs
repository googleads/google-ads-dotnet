...
namespace Google.Ads.GoogleAds.V2.Services
{
    ...
    public sealed partial class GenderViewServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetGenderViewSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class GenderViewServiceClient
    {
        ...
        /// <remarks>The default GenderViewService scopes are:<list type="bullet"></list></remarks>
