...
namespace Google.Ads.GoogleAds.V2.Services
{
    ...
    public sealed partial class GeoTargetConstantServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetGeoTargetConstantSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings SuggestGeoTargetConstantsSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class GeoTargetConstantServiceClient
    {
        ...
        /// <remarks>The default GeoTargetConstantService scopes are:<list type="bullet"></list></remarks>
