...
namespace Google.Ads.GoogleAds.V2.Services
{
    ...
    public sealed partial class GeographicViewServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetGeographicViewSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class GeographicViewServiceClient
    {
        ...
        /// <remarks>The default GeographicViewService scopes are:<list type="bullet"></list></remarks>
