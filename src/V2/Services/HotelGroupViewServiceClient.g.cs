...
namespace Google.Ads.GoogleAds.V2.Services
{
    ...
    public sealed partial class HotelGroupViewServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetHotelGroupViewSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class HotelGroupViewServiceClient
    {
        ...
        /// <remarks>The default HotelGroupViewService scopes are:<list type="bullet"></list></remarks>
