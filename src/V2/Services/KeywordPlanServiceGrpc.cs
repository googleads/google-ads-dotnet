...
namespace Google.Ads.GoogleAds.V2.Services {
  ...
  public static partial class KeywordPlanService
  {
    ...
    {
      serviceBinder.AddMethod(__Method_GetKeywordPlan, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Google.Ads.GoogleAds.V2.Services.GetKeywordPlanRequest, global::Google.Ads.GoogleAds.V2.Resources.KeywordPlan>(serviceImpl.GetKeywordPlan));
      serviceBinder.AddMethod(__Method_MutateKeywordPlans, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Google.Ads.GoogleAds.V2.Services.MutateKeywordPlansRequest, global::Google.Ads.GoogleAds.V2.Services.MutateKeywordPlansResponse>(serviceImpl.MutateKeywordPlans));
      serviceBinder.AddMethod(__Method_GenerateForecastMetrics, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Google.Ads.GoogleAds.V2.Services.GenerateForecastMetricsRequest, global::Google.Ads.GoogleAds.V2.Services.GenerateForecastMetricsResponse>(serviceImpl.GenerateForecastMetrics));
      serviceBinder.AddMethod(__Method_GenerateHistoricalMetrics, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Google.Ads.GoogleAds.V2.Services.GenerateHistoricalMetricsRequest, global::Google.Ads.GoogleAds.V2.Services.GenerateHistoricalMetricsResponse>(serviceImpl.GenerateHistoricalMetrics));
    }
