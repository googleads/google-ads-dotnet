...
namespace Google.Ads.GoogleAds.V2.Services
{
    ...
    public sealed partial class KeywordViewServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetKeywordViewSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class KeywordViewServiceClient
    {
        ...
        /// <remarks>The default KeywordViewService scopes are:<list type="bullet"></list></remarks>
