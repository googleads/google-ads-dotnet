...
namespace Google.Ads.GoogleAds.V2.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="AdParameterServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class AdParameterServiceClientBuilder : gaxgrpc::ClientBuilderBase<AdParameterServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<AdParameterServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => AdParameterServiceClient.DefaultEndpoint;
