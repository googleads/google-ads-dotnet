...
namespace Google.Ads.GoogleAds.V2.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="ChangeStatusServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class ChangeStatusServiceClientBuilder : gaxgrpc::ClientBuilderBase<ChangeStatusServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<ChangeStatusServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => ChangeStatusServiceClient.DefaultEndpoint;
