...
{
    /// <summary>
    /// Settings for a <see cref="ExpandedLandingPageViewServiceClient"/>.
    /// </summary>
    public sealed partial class ExpandedLandingPageViewServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        /// <summary>
        /// Get a new instance of the default <see cref="ExpandedLandingPageViewServiceSettings"/>.
        /// </summary>
        /// <returns>
        /// A new instance of the default <see cref="ExpandedLandingPageViewServiceSettings"/>.
        /// </returns>
        ...
        /// for "Idempotent" <see cref="ExpandedLandingPageViewServiceClient"/> RPC methods.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// The filter specifying which RPC <see cref="grpccore::StatusCode"/>s are eligible for retry
        /// for "NonIdempotent" <see cref="ExpandedLandingPageViewServiceClient"/> RPC methods.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// "Default" retry backoff for <see cref="ExpandedLandingPageViewServiceClient"/> RPC methods.
        /// </summary>
        /// <returns>
        /// The "Default" retry backoff for <see cref="ExpandedLandingPageViewServiceClient"/> RPC methods.
        /// </returns>
        /// <remarks>
        /// The "Default" retry backoff for <see cref="ExpandedLandingPageViewServiceClient"/> RPC methods is defined as:
        /// <list type="bullet">
        ...
        /// <summary>
        /// "Default" timeout backoff for <see cref="ExpandedLandingPageViewServiceClient"/> RPC methods.
        /// </summary>
        /// <returns>
        /// The "Default" timeout backoff for <see cref="ExpandedLandingPageViewServiceClient"/> RPC methods.
        /// </returns>
        /// <remarks>
        /// The "Default" timeout backoff for <see cref="ExpandedLandingPageViewServiceClient"/> RPC methods is defined as:
        /// <list type="bullet">
        ...
        /// <c>ExpandedLandingPageViewServiceClient.GetExpandedLandingPageView</c> and <c>ExpandedLandingPageViewServiceClient.GetExpandedLandingPageViewAsync</c>.
        /// </summary>
        /// <remarks>
        /// The default <c>ExpandedLandingPageViewServiceClient.GetExpandedLandingPageView</c> and
        /// <c>ExpandedLandingPageViewServiceClient.GetExpandedLandingPageViewAsync</c> <see cref="gaxgrpc::RetrySettings"/> are:
        /// <list type="bullet">
        ...
        /// </remarks>
        public gaxgrpc::CallSettings GetExpandedLandingPageViewSettings { get; set; } = gaxgrpc::CallSettings.FromCallTiming(
    ...
    /// <summary>
    /// Builder class for <see cref="ExpandedLandingPageViewServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class ExpandedLandingPageViewServiceClientBuilder : gaxgrpc::ClientBuilderBase<ExpandedLandingPageViewServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<ExpandedLandingPageViewServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => ExpandedLandingPageViewServiceClient.DefaultEndpoint;

        /// <inheritdoc />
        protected override scg::IReadOnlyList<string> GetDefaultScopes() => ExpandedLandingPageViewServiceClient.DefaultScopes;
    ...
    /// <summary>
    /// ExpandedLandingPageViewService client wrapper, for convenient use.
    /// </summary>
    public abstract partial class ExpandedLandingPageViewServiceClient
    {
        /// <summary>
        /// The default endpoint for the ExpandedLandingPageViewService service, which is a host of "googleads.googleapis.com" and a port of 443.
        /// </summary>
        public static gaxgrpc::ServiceEndpoint DefaultEndpoint { get; } = new gaxgrpc::ServiceEndpoint("googleads.googleapis.com", 443);

        /// <summary>
        /// The default ExpandedLandingPageViewService scopes.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Asynchronously creates a <see cref="ExpandedLandingPageViewServiceClient"/>, applying defaults for all unspecified settings,
        ...
        /// ExpandedLandingPageViewServiceClient client = await ExpandedLandingPageViewServiceClient.CreateAsync();
        /// </code>
        ...
        public static async stt::Task<ExpandedLandingPageViewServiceClient> CreateAsync(gaxgrpc::ServiceEndpoint endpoint = null, ExpandedLandingPageViewServiceSettings settings = null)
        {
        ...
        /// <summary>
        /// Creates a <see cref="ExpandedLandingPageViewServiceClient"/> which uses the specified channel for remote operations.
        /// </summary>
        /// <param name="channel">The <see cref="grpccore::Channel"/> for remote operations. Must not be null.</param>
        /// <param name="settings">Optional <see cref="ExpandedLandingPageViewServiceSettings"/>.</param>
        /// <returns>The created <see cref="ExpandedLandingPageViewServiceClient"/>.</returns>
        public static ExpandedLandingPageViewServiceClient Create(grpccore::Channel channel, ExpandedLandingPageViewServiceSettings settings = null)
        {
        ...
        /// <summary>
        /// Shuts down any channels automatically created by <see cref="Create(gaxgrpc::ServiceEndpoint, ExpandedLandingPageViewServiceSettings)"/>
        /// and <see cref="CreateAsync(gaxgrpc::ServiceEndpoint, ExpandedLandingPageViewServiceSettings)"/>. Channels which weren't automatically
        /// created are not affected.
        /// </summary>
        /// <remarks>After calling this method, further calls to <see cref="Create(gaxgrpc::ServiceEndpoint, ExpandedLandingPageViewServiceSettings)"/>
        /// and <see cref="CreateAsync(gaxgrpc::ServiceEndpoint, ExpandedLandingPageViewServiceSettings)"/> will create new channels, which could
        /// in turn be shut down by another call to this method.</remarks>
        /// <returns>A task representing the asynchronous shutdown operation.</returns>
        public static stt::Task ShutdownDefaultChannelsAsync() => s_channelPool.ShutdownChannelsAsync();

        /// <summary>
        /// The underlying gRPC ExpandedLandingPageViewService client.
        /// </summary>
        public virtual ExpandedLandingPageViewService.ExpandedLandingPageViewServiceClient GrpcClient
        {
        ...
        /// </returns>
        public virtual stt::Task<gagvr::ExpandedLandingPageView> GetExpandedLandingPageViewAsync(
            string resourceName,
            gaxgrpc::CallSettings callSettings = null) => GetExpandedLandingPageViewAsync(
                new GetExpandedLandingPageViewRequest
                {
        ...
        public virtual stt::Task<gagvr::ExpandedLandingPageView> GetExpandedLandingPageViewAsync(
            string resourceName,
            st::CancellationToken cancellationToken) => GetExpandedLandingPageViewAsync(
                resourceName,
        ...
        /// The RPC response.
        /// </returns>
        public virtual gagvr::ExpandedLandingPageView GetExpandedLandingPageView(
            string resourceName,
            gaxgrpc::CallSettings callSettings = null) => GetExpandedLandingPageView(
                new GetExpandedLandingPageViewRequest
                {
                    ResourceName = gax::GaxPreconditions.CheckNotNullOrEmpty(resourceName, nameof(resourceName)),
                },
    ...
    /// <summary>
    /// ExpandedLandingPageViewService client wrapper implementation, for convenient use.
    /// </summary>
    public sealed partial class ExpandedLandingPageViewServiceClientImpl : ExpandedLandingPageViewServiceClient
    {
        ...
        /// A Task containing the RPC response.
        /// </returns>
        public override stt::Task<gagvr::ExpandedLandingPageView> GetExpandedLandingPageViewAsync(
            GetExpandedLandingPageViewRequest request,
            gaxgrpc::CallSettings callSettings = null)
        {
        ...
        /// The RPC response.
        /// </returns>
        public override gagvr::ExpandedLandingPageView GetExpandedLandingPageView(
            GetExpandedLandingPageViewRequest request,
            gaxgrpc::CallSettings callSettings = null)
        {
            Modify_GetExpandedLandingPageViewRequest(ref request, ref callSettings);
