...
namespace Google.Ads.GoogleAds.V2.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="ParentalStatusViewServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class ParentalStatusViewServiceClientBuilder : gaxgrpc::ClientBuilderBase<ParentalStatusViewServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<ParentalStatusViewServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => ParentalStatusViewServiceClient.DefaultEndpoint;
