...
namespace Google.Ads.GoogleAds.V2.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="ProductBiddingCategoryConstantServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class ProductBiddingCategoryConstantServiceClientBuilder : gaxgrpc::ClientBuilderBase<ProductBiddingCategoryConstantServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<ProductBiddingCategoryConstantServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => ProductBiddingCategoryConstantServiceClient.DefaultEndpoint;

        /// <inheritdoc />
        protected override scg::IReadOnlyList<string> GetDefaultScopes() => ProductBiddingCategoryConstantServiceClient.DefaultScopes;
