...
namespace Google.Ads.GoogleAds.V2.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="SharedCriterionServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class SharedCriterionServiceClientBuilder : gaxgrpc::ClientBuilderBase<SharedCriterionServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<SharedCriterionServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => SharedCriterionServiceClient.DefaultEndpoint;
