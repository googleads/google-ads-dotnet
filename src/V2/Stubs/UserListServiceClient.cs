...
namespace Google.Ads.GoogleAds.V2.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="UserListServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class UserListServiceClientBuilder : gaxgrpc::ClientBuilderBase<UserListServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<UserListServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => UserListServiceClient.DefaultEndpoint;
