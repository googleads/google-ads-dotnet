...
using static Google.Ads.GoogleAds.V3.Enums.FeedItemTargetTypeEnum.Types;
using static Google.Ads.GoogleAds.V3.Enums.PlaceholderTypeEnum.Types;
using static Google.Ads.GoogleAds.V3.Enums.SimulationModificationMethodEnum.Types;
using static Google.Ads.GoogleAds.V3.Enums.SimulationTypeEnum.Types;
