...
namespace Google.Ads.GoogleAds.V3.Resources
{
    ...
    public sealed partial class CampaignBudgetName : gax::IResourceName, sys::IEquatable<CampaignBudgetName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>customers/{customer}/campaignBudgets/{campaign_budget}</c>.
            /// </summary>
            CustomerCampaignBudget = 1
        }

        private static gax::PathTemplate s_customerCampaignBudget = new gax::PathTemplate("customers/{customer}/campaignBudgets/{campaign_budget}");
        ...
        /// <c>customers/{customer}/campaignBudgets/{campaign_budget}</c>.
        /// </summary>
        ...
        /// <list type="bullet">
        /// <item><description><c>customers/{customer}/campaignBudgets/{campaign_budget}</c></description></item>
        /// </list>
        /// </remarks>
