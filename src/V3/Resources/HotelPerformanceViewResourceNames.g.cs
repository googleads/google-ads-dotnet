...
namespace Google.Ads.GoogleAds.V3.Resources
{
    ...
    public sealed partial class HotelPerformanceViewName : gax::IResourceName, sys::IEquatable<HotelPerformanceViewName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>A resource name with pattern <c>customers/{customer}/hotelPerformanceView</c>.</summary>
            Customer = 1,
        }

        private static gax::PathTemplate s_customer = new gax::PathTemplate("customers/{customer}/hotelPerformanceView");
        ...
        /// <c>customers/{customer}/hotelPerformanceView</c>.
        /// </summary>
        ...
        /// <list type="bullet">
        /// <item><description><c>customers/{customer}/hotelPerformanceView</c></description></item>
        /// </list>
        /// </remarks>
        ...
        /// pattern <c>customers/{customer}/hotelPerformanceView</c>
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
