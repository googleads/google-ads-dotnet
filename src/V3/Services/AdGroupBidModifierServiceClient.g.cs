...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    public sealed partial class AdGroupBidModifierServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetAdGroupBidModifierSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings MutateAdGroupBidModifiersSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class AdGroupBidModifierServiceClient
    {
        ...
        /// <remarks>The default AdGroupBidModifierService scopes are:<list type="bullet"></list></remarks>
