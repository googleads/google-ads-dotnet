...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    public sealed partial class AdGroupCriterionServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetAdGroupCriterionSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings MutateAdGroupCriteriaSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class AdGroupCriterionServiceClient
    {
        ...
        /// <remarks>The default AdGroupCriterionService scopes are:<list type="bullet"></list></remarks>
