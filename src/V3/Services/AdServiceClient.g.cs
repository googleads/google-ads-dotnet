...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    public sealed partial class AdServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetAdSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings MutateAdsSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class AdServiceClient
    {
        ...
        /// <remarks>The default AdService scopes are:<list type="bullet"></list></remarks>
