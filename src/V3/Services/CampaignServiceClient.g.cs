...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    public sealed partial class CampaignServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetCampaignSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings MutateCampaignsSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class CampaignServiceClient
    {
        ...
        /// <remarks>The default CampaignService scopes are:<list type="bullet"></list></remarks>
