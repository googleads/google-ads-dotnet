...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    public sealed partial class InvoiceServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings ListInvoicesSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class InvoiceServiceClient
    {
        ...
        /// <remarks>The default InvoiceService scopes are:<list type="bullet"></list></remarks>
