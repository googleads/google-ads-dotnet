...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    public sealed partial class TopicViewServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetTopicViewSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class TopicViewServiceClient
    {
        ...
        /// <remarks>The default TopicViewService scopes are:<list type="bullet"></list></remarks>
