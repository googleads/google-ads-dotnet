...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="AccountBudgetProposalServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class AccountBudgetProposalServiceClientBuilder : gaxgrpc::ClientBuilderBase<AccountBudgetProposalServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<AccountBudgetProposalServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => AccountBudgetProposalServiceClient.DefaultEndpoint;
