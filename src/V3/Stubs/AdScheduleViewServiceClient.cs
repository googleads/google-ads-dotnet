...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="AdScheduleViewServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class AdScheduleViewServiceClientBuilder : gaxgrpc::ClientBuilderBase<AdScheduleViewServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<AdScheduleViewServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => AdScheduleViewServiceClient.DefaultEndpoint;
