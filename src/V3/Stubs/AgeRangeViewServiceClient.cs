...
{
    /// <summary>
    /// Settings for a <see cref="AgeRangeViewServiceClient"/>.
    /// </summary>
    public sealed partial class AgeRangeViewServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        /// <summary>
        /// Get a new instance of the default <see cref="AgeRangeViewServiceSettings"/>.
        /// </summary>
        /// <returns>
        /// A new instance of the default <see cref="AgeRangeViewServiceSettings"/>.
        /// </returns>
        public static AgeRangeViewServiceSettings GetDefault() => new AgeRangeViewServiceSettings();

        /// <summary>
        /// Constructs a new <see cref="AgeRangeViewServiceSettings"/> object with default settings.
        /// </summary>
        ...
        /// for "Idempotent" <see cref="AgeRangeViewServiceClient"/> RPC methods.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// The filter specifying which RPC <see cref="grpccore::StatusCode"/>s are eligible for retry
        /// for "NonIdempotent" <see cref="AgeRangeViewServiceClient"/> RPC methods.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// "Default" retry backoff for <see cref="AgeRangeViewServiceClient"/> RPC methods.
        /// </summary>
        /// <returns>
        /// The "Default" retry backoff for <see cref="AgeRangeViewServiceClient"/> RPC methods.
        /// </returns>
        /// <remarks>
        /// The "Default" retry backoff for <see cref="AgeRangeViewServiceClient"/> RPC methods is defined as:
        /// <list type="bullet">
        ...
        /// <summary>
        /// "Default" timeout backoff for <see cref="AgeRangeViewServiceClient"/> RPC methods.
        /// </summary>
        /// <returns>
        /// The "Default" timeout backoff for <see cref="AgeRangeViewServiceClient"/> RPC methods.
        /// </returns>
        /// <remarks>
        /// The "Default" timeout backoff for <see cref="AgeRangeViewServiceClient"/> RPC methods is defined as:
        /// <list type="bullet">
        ...
        /// </summary>
        /// <remarks>
        /// The default <c>AgeRangeViewServiceClient.GetAgeRangeView</c> and
        /// <c>AgeRangeViewServiceClient.GetAgeRangeViewAsync</c> <see cref="gaxgrpc::RetrySettings"/> are:
        /// <list type="bullet">
        ...
        /// </remarks>
        public gaxgrpc::CallSettings GetAgeRangeViewSettings { get; set; } = gaxgrpc::CallSettings.FromCallTiming(
    ...
    /// <summary>
    /// Builder class for <see cref="AgeRangeViewServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class AgeRangeViewServiceClientBuilder : gaxgrpc::ClientBuilderBase<AgeRangeViewServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<AgeRangeViewServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => AgeRangeViewServiceClient.DefaultEndpoint;
    ...
    /// <summary>
    /// AgeRangeViewService client wrapper, for convenient use.
    /// </summary>
    public abstract partial class AgeRangeViewServiceClient
    {
        /// <summary>
        /// The default endpoint for the AgeRangeViewService service, which is a host of "googleads.googleapis.com" and a port of 443.
        /// </summary>
        public static gaxgrpc::ServiceEndpoint DefaultEndpoint { get; } = new gaxgrpc::ServiceEndpoint("googleads.googleapis.com", 443);

        /// <summary>
        /// The default AgeRangeViewService scopes.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Shuts down any channels automatically created by <see cref="Create(gaxgrpc::ServiceEndpoint, AgeRangeViewServiceSettings)"/>
        /// and <see cref="CreateAsync(gaxgrpc::ServiceEndpoint, AgeRangeViewServiceSettings)"/>. Channels which weren't automatically
        /// created are not affected.
        /// </summary>
        /// <remarks>After calling this method, further calls to <see cref="Create(gaxgrpc::ServiceEndpoint, AgeRangeViewServiceSettings)"/>
        /// and <see cref="CreateAsync(gaxgrpc::ServiceEndpoint, AgeRangeViewServiceSettings)"/> will create new channels, which could
        /// in turn be shut down by another call to this method.</remarks>
        /// <returns>A task representing the asynchronous shutdown operation.</returns>
        public static stt::Task ShutdownDefaultChannelsAsync() => s_channelPool.ShutdownChannelsAsync();

        /// <summary>
        /// The underlying gRPC AgeRangeViewService client.
        /// </summary>
        public virtual AgeRangeViewService.AgeRangeViewServiceClient GrpcClient
        {
        ...
        /// </returns>
        public virtual stt::Task<gagvr::AgeRangeView> GetAgeRangeViewAsync(
            string resourceName,
            gaxgrpc::CallSettings callSettings = null) => GetAgeRangeViewAsync(
                new GetAgeRangeViewRequest
                {
        ...
        public virtual stt::Task<gagvr::AgeRangeView> GetAgeRangeViewAsync(
            string resourceName,
            st::CancellationToken cancellationToken) => GetAgeRangeViewAsync(
                resourceName,
        ...
        /// The RPC response.
        /// </returns>
        public virtual gagvr::AgeRangeView GetAgeRangeView(
            string resourceName,
            gaxgrpc::CallSettings callSettings = null) => GetAgeRangeView(
                new GetAgeRangeViewRequest
                {
                    ResourceName = gax::GaxPreconditions.CheckNotNullOrEmpty(resourceName, nameof(resourceName)),
                },
    ...
    /// <summary>
    /// AgeRangeViewService client wrapper implementation, for convenient use.
    /// </summary>
    public sealed partial class AgeRangeViewServiceClientImpl : AgeRangeViewServiceClient
    {
        ...
        /// A Task containing the RPC response.
        /// </returns>
        public override stt::Task<gagvr::AgeRangeView> GetAgeRangeViewAsync(
            GetAgeRangeViewRequest request,
            gaxgrpc::CallSettings callSettings = null)
        {
        ...
        /// The RPC response.
        /// </returns>
        public override gagvr::AgeRangeView GetAgeRangeView(
            GetAgeRangeViewRequest request,
            gaxgrpc::CallSettings callSettings = null)
        {
            Modify_GetAgeRangeViewRequest(ref request, ref callSettings);
