...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="BiddingStrategyServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class BiddingStrategyServiceClientBuilder : gaxgrpc::ClientBuilderBase<BiddingStrategyServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<BiddingStrategyServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => BiddingStrategyServiceClient.DefaultEndpoint;
