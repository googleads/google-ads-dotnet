...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="CampaignBidModifierServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class CampaignBidModifierServiceClientBuilder : gaxgrpc::ClientBuilderBase<CampaignBidModifierServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<CampaignBidModifierServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => CampaignBidModifierServiceClient.DefaultEndpoint;
