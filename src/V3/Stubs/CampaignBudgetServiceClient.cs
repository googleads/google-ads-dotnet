...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="CampaignBudgetServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class CampaignBudgetServiceClientBuilder : gaxgrpc::ClientBuilderBase<CampaignBudgetServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<CampaignBudgetServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => CampaignBudgetServiceClient.DefaultEndpoint;
