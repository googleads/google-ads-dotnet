...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="CampaignExperimentServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class CampaignExperimentServiceClientBuilder : gaxgrpc::ClientBuilderBase<CampaignExperimentServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<CampaignExperimentServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => CampaignExperimentServiceClient.DefaultEndpoint;
