...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="CampaignSharedSetServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class CampaignSharedSetServiceClientBuilder : gaxgrpc::ClientBuilderBase<CampaignSharedSetServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<CampaignSharedSetServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => CampaignSharedSetServiceClient.DefaultEndpoint;
