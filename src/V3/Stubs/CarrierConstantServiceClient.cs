...
{
    /// <summary>
    /// Settings for a <see cref="CarrierConstantServiceClient"/>.
    /// </summary>
    public sealed partial class CarrierConstantServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        /// <summary>
        /// Get a new instance of the default <see cref="CarrierConstantServiceSettings"/>.
        /// </summary>
        /// <returns>
        /// A new instance of the default <see cref="CarrierConstantServiceSettings"/>.
        /// </returns>
        ...
        /// for "Idempotent" <see cref="CarrierConstantServiceClient"/> RPC methods.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// The filter specifying which RPC <see cref="grpccore::StatusCode"/>s are eligible for retry
        /// for "NonIdempotent" <see cref="CarrierConstantServiceClient"/> RPC methods.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// "Default" retry backoff for <see cref="CarrierConstantServiceClient"/> RPC methods.
        /// </summary>
        /// <returns>
        /// The "Default" retry backoff for <see cref="CarrierConstantServiceClient"/> RPC methods.
        /// </returns>
        /// <remarks>
        /// The "Default" retry backoff for <see cref="CarrierConstantServiceClient"/> RPC methods is defined as:
        /// <list type="bullet">
        ...
        /// <summary>
        /// "Default" timeout backoff for <see cref="CarrierConstantServiceClient"/> RPC methods.
        /// </summary>
        /// <returns>
        /// The "Default" timeout backoff for <see cref="CarrierConstantServiceClient"/> RPC methods.
        /// </returns>
        /// <remarks>
        /// The "Default" timeout backoff for <see cref="CarrierConstantServiceClient"/> RPC methods is defined as:
        /// <list type="bullet">
        ...
        /// <c>CarrierConstantServiceClient.GetCarrierConstant</c> and <c>CarrierConstantServiceClient.GetCarrierConstantAsync</c>.
        /// </summary>
        /// <remarks>
        /// The default <c>CarrierConstantServiceClient.GetCarrierConstant</c> and
        /// <c>CarrierConstantServiceClient.GetCarrierConstantAsync</c> <see cref="gaxgrpc::RetrySettings"/> are:
        /// <list type="bullet">
        ...
        /// </remarks>
        public gaxgrpc::CallSettings GetCarrierConstantSettings { get; set; } = gaxgrpc::CallSettings.FromCallTiming(
    ...
    /// <summary>
    /// Builder class for <see cref="CarrierConstantServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class CarrierConstantServiceClientBuilder : gaxgrpc::ClientBuilderBase<CarrierConstantServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<CarrierConstantServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => CarrierConstantServiceClient.DefaultEndpoint;
    ...
    /// <summary>
    /// CarrierConstantService client wrapper, for convenient use.
    /// </summary>
    public abstract partial class CarrierConstantServiceClient
    {
        /// <summary>
        /// The default endpoint for the CarrierConstantService service, which is a host of "googleads.googleapis.com" and a port of 443.
        /// </summary>
        public static gaxgrpc::ServiceEndpoint DefaultEndpoint { get; } = new gaxgrpc::ServiceEndpoint("googleads.googleapis.com", 443);

        /// <summary>
        /// The default CarrierConstantService scopes.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Asynchronously creates a <see cref="CarrierConstantServiceClient"/>, applying defaults for all unspecified settings,
        ...
        /// CarrierConstantServiceClient client = await CarrierConstantServiceClient.CreateAsync();
        /// </code>
        ...
        public static async stt::Task<CarrierConstantServiceClient> CreateAsync(gaxgrpc::ServiceEndpoint endpoint = null, CarrierConstantServiceSettings settings = null)
        {
        ...
        /// <summary>
        /// Creates a <see cref="CarrierConstantServiceClient"/> which uses the specified channel for remote operations.
        /// </summary>
        /// <param name="channel">The <see cref="grpccore::Channel"/> for remote operations. Must not be null.</param>
        /// <param name="settings">Optional <see cref="CarrierConstantServiceSettings"/>.</param>
        /// <returns>The created <see cref="CarrierConstantServiceClient"/>.</returns>
        public static CarrierConstantServiceClient Create(grpccore::Channel channel, CarrierConstantServiceSettings settings = null)
        {
        ...
        /// <summary>
        /// Creates a <see cref="CarrierConstantServiceClient"/> which uses the specified call invoker for remote operations.
        /// </summary>
        /// <param name="callInvoker">The <see cref="grpccore::CallInvoker"/> for remote operations. Must not be null.</param>
        /// <param name="settings">Optional <see cref="CarrierConstantServiceSettings"/>.</param>
        /// <returns>The created <see cref="CarrierConstantServiceClient"/>.</returns>
        public static CarrierConstantServiceClient Create(grpccore::CallInvoker callInvoker, CarrierConstantServiceSettings settings = null)
        {
        ...
        /// <summary>
        /// Shuts down any channels automatically created by <see cref="Create(gaxgrpc::ServiceEndpoint, CarrierConstantServiceSettings)"/>
        /// and <see cref="CreateAsync(gaxgrpc::ServiceEndpoint, CarrierConstantServiceSettings)"/>. Channels which weren't automatically
        /// created are not affected.
        /// </summary>
        /// <remarks>After calling this method, further calls to <see cref="Create(gaxgrpc::ServiceEndpoint, CarrierConstantServiceSettings)"/>
        /// and <see cref="CreateAsync(gaxgrpc::ServiceEndpoint, CarrierConstantServiceSettings)"/> will create new channels, which could
        /// in turn be shut down by another call to this method.</remarks>
        /// <returns>A task representing the asynchronous shutdown operation.</returns>
        public static stt::Task ShutdownDefaultChannelsAsync() => s_channelPool.ShutdownChannelsAsync();

        /// <summary>
        /// The underlying gRPC CarrierConstantService client.
        /// </summary>
        public virtual CarrierConstantService.CarrierConstantServiceClient GrpcClient
        {
        ...
        /// </returns>
        public virtual stt::Task<gagvr::CarrierConstant> GetCarrierConstantAsync(
            string resourceName,
            gaxgrpc::CallSettings callSettings = null) => GetCarrierConstantAsync(
                new GetCarrierConstantRequest
                {
        ...
        public virtual stt::Task<gagvr::CarrierConstant> GetCarrierConstantAsync(
            string resourceName,
            st::CancellationToken cancellationToken) => GetCarrierConstantAsync(
                resourceName,
        ...
        /// The RPC response.
        /// </returns>
        public virtual gagvr::CarrierConstant GetCarrierConstant(
            string resourceName,
            gaxgrpc::CallSettings callSettings = null) => GetCarrierConstant(
                new GetCarrierConstantRequest
                {
                    ResourceName = gax::GaxPreconditions.CheckNotNullOrEmpty(resourceName, nameof(resourceName)),
                },
    ...
    /// <summary>
    /// CarrierConstantService client wrapper implementation, for convenient use.
    /// </summary>
    public sealed partial class CarrierConstantServiceClientImpl : CarrierConstantServiceClient
    {
        ...
        /// A Task containing the RPC response.
        /// </returns>
        public override stt::Task<gagvr::CarrierConstant> GetCarrierConstantAsync(
            GetCarrierConstantRequest request,
            gaxgrpc::CallSettings callSettings = null)
        {
        ...
        /// The RPC response.
        /// </returns>
        public override gagvr::CarrierConstant GetCarrierConstant(
            GetCarrierConstantRequest request,
            gaxgrpc::CallSettings callSettings = null)
        {
            Modify_GetCarrierConstantRequest(ref request, ref callSettings);
