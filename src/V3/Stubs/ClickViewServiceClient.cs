...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="ClickViewServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class ClickViewServiceClientBuilder : gaxgrpc::ClientBuilderBase<ClickViewServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<ClickViewServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => ClickViewServiceClient.DefaultEndpoint;
