...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="ConversionUploadServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class ConversionUploadServiceClientBuilder : gaxgrpc::ClientBuilderBase<ConversionUploadServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<ConversionUploadServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => ConversionUploadServiceClient.DefaultEndpoint;
