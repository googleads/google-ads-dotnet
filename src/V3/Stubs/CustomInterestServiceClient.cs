...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="CustomInterestServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class CustomInterestServiceClientBuilder : gaxgrpc::ClientBuilderBase<CustomInterestServiceClient>
    {
        /// <summary>
        ...
        /// <inheritdoc />
        public override async stt::Task<CustomInterestServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => CustomInterestServiceClient.DefaultEndpoint;
