...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="FeedItemServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class FeedItemServiceClientBuilder : gaxgrpc::ClientBuilderBase<FeedItemServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<FeedItemServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => FeedItemServiceClient.DefaultEndpoint;
