...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="GoogleAdsFieldServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class GoogleAdsFieldServiceClientBuilder : gaxgrpc::ClientBuilderBase<GoogleAdsFieldServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<GoogleAdsFieldServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => GoogleAdsFieldServiceClient.DefaultEndpoint;
