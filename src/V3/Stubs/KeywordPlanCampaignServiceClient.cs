...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="KeywordPlanCampaignServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class KeywordPlanCampaignServiceClientBuilder : gaxgrpc::ClientBuilderBase<KeywordPlanCampaignServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<KeywordPlanCampaignServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => KeywordPlanCampaignServiceClient.DefaultEndpoint;
