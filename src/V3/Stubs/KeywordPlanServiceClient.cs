...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="KeywordPlanServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class KeywordPlanServiceClientBuilder : gaxgrpc::ClientBuilderBase<KeywordPlanServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<KeywordPlanServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => KeywordPlanServiceClient.DefaultEndpoint;
