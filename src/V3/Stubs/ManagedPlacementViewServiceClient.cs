...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="ManagedPlacementViewServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class ManagedPlacementViewServiceClientBuilder : gaxgrpc::ClientBuilderBase<ManagedPlacementViewServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<ManagedPlacementViewServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => ManagedPlacementViewServiceClient.DefaultEndpoint;
