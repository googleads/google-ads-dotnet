    ...
    static OfflineUserDataReflection() {
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Google.Ads.GoogleAds.V3.Common.OfflineUserAddressInfo), global::Google.Ads.GoogleAds.V3.Common.OfflineUserAddressInfo.Parser, new[]{ "HashedFirstName", "HashedLastName", "City", "State", "CountryCode", "PostalCode" }, null, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::Google.Ads.GoogleAds.V3.Common.UserIdentifier), global::Google.Ads.GoogleAds.V3.Common.UserIdentifier.Parser, new[]{ "HashedEmail", "HashedPhoneNumber", "MobileId", "ThirdPartyUserId", "AddressInfo" }, new[]{ "Identifier" }, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::Google.Ads.GoogleAds.V3.Common.TransactionAttribute), global::Google.Ads.GoogleAds.V3.Common.TransactionAttribute.Parser, new[]{ "TransactionDateTime", "TransactionAmountMicros", "CurrencyCode", "ConversionAction", "OrderId", "StoreAttribute", "CustomValue" }, null, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::Google.Ads.GoogleAds.V3.Common.StoreAttribute), global::Google.Ads.GoogleAds.V3.Common.StoreAttribute.Parser, new[]{ "StoreCode" }, null, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::Google.Ads.GoogleAds.V3.Common.UserData), global::Google.Ads.GoogleAds.V3.Common.UserData.Parser, new[]{ "UserIdentifiers", "TransactionAttribute" }, null, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::Google.Ads.GoogleAds.V3.Common.CustomerMatchUserListMetadata), global::Google.Ads.GoogleAds.V3.Common.CustomerMatchUserListMetadata.Parser, new[]{ "UserList" }, null, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::Google.Ads.GoogleAds.V3.Common.StoreSalesMetadata), global::Google.Ads.GoogleAds.V3.Common.StoreSalesMetadata.Parser, new[]{ "LoyaltyFraction", "TransactionUploadFraction", "CustomKey", "ThirdPartyMetadata" }, null, null, null),
