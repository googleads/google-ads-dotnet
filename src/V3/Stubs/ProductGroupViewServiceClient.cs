...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="ProductGroupViewServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class ProductGroupViewServiceClientBuilder : gaxgrpc::ClientBuilderBase<ProductGroupViewServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<ProductGroupViewServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => ProductGroupViewServiceClient.DefaultEndpoint;
