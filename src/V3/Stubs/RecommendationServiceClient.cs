...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    public sealed partial class RecommendationServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>RecommendationServiceClient.DismissRecommendation</c> and <c>RecommendationServiceClient.DismissRecommendationAsync</c>.
        /// </summary>
        /// <remarks>
        /// The default <c>RecommendationServiceClient.DismissRecommendation</c> and
        /// <c>RecommendationServiceClient.DismissRecommendationAsync</c> <see cref="gaxgrpc::RetrySettings"/> are:
        /// <list type="bullet">
        /// <item><description>Initial retry delay: 5000 milliseconds</description></item>
        /// <item><description>Retry delay multiplier: 1.3</description></item>
        /// <item><description>Retry maximum delay: 60000 milliseconds</description></item>
        ...
        /// Default RPC expiration is 3600000 milliseconds.
        /// </remarks>
        public gaxgrpc::CallSettings DismissRecommendationSettings { get; set; } = gaxgrpc::CallSettings.FromCallTiming(
            gaxgrpc::CallTiming.FromRetry(new gaxgrpc::RetrySettings(
                retryBackoff: GetDefaultRetryBackoff(),
                timeoutBackoff: GetDefaultTimeoutBackoff(),
                totalExpiration: gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(3600000)),
    ...
    /// <summary>
    /// Builder class for <see cref="RecommendationServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class RecommendationServiceClientBuilder : gaxgrpc::ClientBuilderBase<RecommendationServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<RecommendationServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => RecommendationServiceClient.DefaultEndpoint;
    ...
    public sealed partial class RecommendationServiceClientImpl : RecommendationServiceClient
    {
        ...
        /// A Task containing the RPC response.
        /// </returns>
        public override stt::Task<DismissRecommendationResponse> DismissRecommendationAsync(
            DismissRecommendationRequest request,
            gaxgrpc::CallSettings callSettings = null)
        {
        ...
        /// The RPC response.
        /// </returns>
        public override DismissRecommendationResponse DismissRecommendation(
            DismissRecommendationRequest request,
            gaxgrpc::CallSettings callSettings = null)
        {
            Modify_DismissRecommendationRequest(ref request, ref callSettings);
