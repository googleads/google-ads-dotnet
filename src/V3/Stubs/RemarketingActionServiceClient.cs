...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="RemarketingActionServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class RemarketingActionServiceClientBuilder : gaxgrpc::ClientBuilderBase<RemarketingActionServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<RemarketingActionServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => RemarketingActionServiceClient.DefaultEndpoint;
