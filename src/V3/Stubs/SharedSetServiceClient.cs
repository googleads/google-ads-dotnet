...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="SharedSetServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class SharedSetServiceClientBuilder : gaxgrpc::ClientBuilderBase<SharedSetServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<SharedSetServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => SharedSetServiceClient.DefaultEndpoint;
