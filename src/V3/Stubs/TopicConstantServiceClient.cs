...
namespace Google.Ads.GoogleAds.V3.Services
{
    ...
    /// <summary>
    /// Builder class for <see cref="TopicConstantServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class TopicConstantServiceClientBuilder : gaxgrpc::ClientBuilderBase<TopicConstantServiceClient>
    {
        ...
        /// <inheritdoc />
        public override async stt::Task<TopicConstantServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => TopicConstantServiceClient.DefaultEndpoint;
