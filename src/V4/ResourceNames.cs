...
using static Google.Ads.GoogleAds.V4.Enums.FeedItemTargetTypeEnum.Types;
using static Google.Ads.GoogleAds.V4.Enums.PlaceholderTypeEnum.Types;
using static Google.Ads.GoogleAds.V4.Enums.SimulationModificationMethodEnum.Types;
using static Google.Ads.GoogleAds.V4.Enums.SimulationTypeEnum.Types;
