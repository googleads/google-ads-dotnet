...
namespace Google.Ads.GoogleAds.V4.Resources
{
    ...
    public sealed partial class AssetName : gax::IResourceName, sys::IEquatable<AssetName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>A resource name with pattern <c>customers/{customer}/assets/{asset}</c>.</summary>
            CustomerAsset = 1
        }

        private static gax::PathTemplate s_customerAsset = new gax::PathTemplate("customers/{customer}/assets/{asset}");
        ...
        /// <summary>
        /// Creates a <see cref="AssetName"/> with the pattern <c>customers/{customer}/assets/{asset}</c>.
        /// </summary>
        ...
        /// <c>customers/{customer}/assets/{asset}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="assetId">The <c>Asset</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        ...
        /// <list type="bullet">
        /// <item><description><c>customers/{customer}/assets/{asset}</c></description></item>
        /// </list>
        /// </remarks>
