...
namespace Google.Ads.GoogleAds.V4.Resources
{
    ...
    public sealed partial class LanguageConstantName : gax::IResourceName, sys::IEquatable<LanguageConstantName>
    {
        ...
        /// <summary>
        /// Creates a <see cref="LanguageConstantName"/> with the pattern <c>languageConstants/{language_constant}</c>.
        /// </summary>
        /// <param name="languageConstantId">The <c>LanguageConstant</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="LanguageConstantName"/> constructed from the provided ids.</returns>
        public static LanguageConstantName FromLanguageConstant(string languageConstantId) =>
            new LanguageConstantName(ResourceNameType.LanguageConstant, languageConstantId: gax::GaxPreconditions.CheckNotNullOrEmpty(languageConstantId, nameof(languageConstantId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="LanguageConstantName"/> with pattern
        /// <c>languageConstants/{language_constant}</c>.
        /// </summary>
        /// <param name="languageConstantId">The <c>LanguageConstant</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        ...
        /// <c>languageConstants/{language_constant}</c>.
        /// </returns>
        public static string Format(string languageConstantId) => FormatLanguageConstant(languageConstantId);
        ...
        /// <c>languageConstants/{language_constant}</c>.
        /// </returns>
        public static string FormatLanguageConstant(string languageConstantId) =>
            s_languageConstant.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(languageConstantId, nameof(languageConstantId)));
        ...
        /// <list type="bullet">
        /// <item><description><c>languageConstants/{language_constant}</c></description></item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string languageConstantName, bool allowUnparsed, out LanguageConstantName result)
        {
            ...
            if (s_languageConstant.TryParseName(languageConstantName, out resourceName))
            {
                result = FromLanguageConstant(resourceName[0]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private LanguageConstantName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string languageConstantId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            LanguageConstantId = languageConstantId;
        }
        ...
        /// </summary>
        /// <param name="languageConstantId">The <c>LanguageConstant</c> ID. Must not be <c>null</c> or empty.</param>
        public LanguageConstantName(string languageConstantId) : this(ResourceNameType.LanguageConstant, languageConstantId: gax::GaxPreconditions.CheckNotNullOrEmpty(languageConstantId, nameof(languageConstantId)))
        {
        }
        ...
        /// <summary>
        /// The <c>LanguageConstant</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource
        /// name.
        /// </summary>
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.LanguageConstant: return s_languageConstant.Expand(LanguageConstantId);
