...
namespace Google.Ads.GoogleAds.V4.Resources
{
    ...
    public sealed partial class OperatingSystemVersionConstantName : gax::IResourceName, sys::IEquatable<OperatingSystemVersionConstantName>
    {
        ...
        /// <c>operatingSystemVersionConstants/{operating_system_version_constant}</c>.
        /// </summary>
        /// <param name="operatingSystemVersionConstantId">
        /// The <c>OperatingSystemVersionConstant</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        /// <returns>
        /// A new instance of <see cref="OperatingSystemVersionConstantName"/> constructed from the provided ids.
        /// </returns>
        public static OperatingSystemVersionConstantName FromOperatingSystemVersionConstant(string operatingSystemVersionConstantId) =>
            new OperatingSystemVersionConstantName(ResourceNameType.OperatingSystemVersionConstant, operatingSystemVersionConstantId: gax::GaxPreconditions.CheckNotNullOrEmpty(operatingSystemVersionConstantId, nameof(operatingSystemVersionConstantId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="OperatingSystemVersionConstantName"/> with
        /// pattern <c>operatingSystemVersionConstants/{operating_system_version_constant}</c>.
        /// </summary>
        /// <param name="operatingSystemVersionConstantId">
        /// The <c>OperatingSystemVersionConstant</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        ...
        public static string Format(string operatingSystemVersionConstantId) =>
            FormatOperatingSystemVersionConstant(operatingSystemVersionConstantId);
        ...
        /// <c>operatingSystemVersionConstants/{operating_system_version_constant}</c>.
        /// </returns>
        public static string FormatOperatingSystemVersionConstant(string operatingSystemVersionConstantId) =>
            s_operatingSystemVersionConstant.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(operatingSystemVersionConstantId, nameof(operatingSystemVersionConstantId)));
        ...
        /// <list type="bullet">
        /// <item>
        /// <description><c>operatingSystemVersionConstants/{operating_system_version_constant}</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string operatingSystemVersionConstantName, bool allowUnparsed, out OperatingSystemVersionConstantName result)
        {
            ...
            if (s_operatingSystemVersionConstant.TryParseName(operatingSystemVersionConstantName, out resourceName))
            {
                result = FromOperatingSystemVersionConstant(resourceName[0]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private OperatingSystemVersionConstantName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string operatingSystemVersionConstantId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            OperatingSystemVersionConstantId = operatingSystemVersionConstantId;
        }

        /// <summary>
        /// Constructs a new instance of a <see cref="OperatingSystemVersionConstantName"/> class from the component
        /// parts of pattern <c>operatingSystemVersionConstants/{operating_system_version_constant}</c>
        /// </summary>
        /// <param name="operatingSystemVersionConstantId">
        /// The <c>OperatingSystemVersionConstant</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        public OperatingSystemVersionConstantName(string operatingSystemVersionConstantId) : this(ResourceNameType.OperatingSystemVersionConstant, operatingSystemVersionConstantId: gax::GaxPreconditions.CheckNotNullOrEmpty(operatingSystemVersionConstantId, nameof(operatingSystemVersionConstantId)))
        {
        }
        ...
        /// <summary>
        /// The <c>OperatingSystemVersionConstant</c> ID. Will not be <c>null</c>, unless this instance contains an
        /// unparsed resource name.
        /// </summary>
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.OperatingSystemVersionConstant: return s_operatingSystemVersionConstant.Expand(OperatingSystemVersionConstantId);
