...
namespace Google.Ads.GoogleAds.V4.Services {
  ...
  public static partial class AccountLinkService
  {
    ...
    static readonly grpc::Marshaller<global::Google.Ads.GoogleAds.V4.Services.GetAccountLinkRequest> __Marshaller_google_ads_googleads_v4_services_GetAccountLinkRequest = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Ads.GoogleAds.V4.Services.GetAccountLinkRequest.Parser));
    static readonly grpc::Marshaller<global::Google.Ads.GoogleAds.V4.Resources.AccountLink> __Marshaller_google_ads_googleads_v4_resources_AccountLink = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Ads.GoogleAds.V4.Resources.AccountLink.Parser));
    static readonly grpc::Marshaller<global::Google.Ads.GoogleAds.V4.Services.MutateAccountLinkRequest> __Marshaller_google_ads_googleads_v4_services_MutateAccountLinkRequest = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Ads.GoogleAds.V4.Services.MutateAccountLinkRequest.Parser));
    static readonly grpc::Marshaller<global::Google.Ads.GoogleAds.V4.Services.MutateAccountLinkResponse> __Marshaller_google_ads_googleads_v4_services_MutateAccountLinkResponse = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Ads.GoogleAds.V4.Services.MutateAccountLinkResponse.Parser));
