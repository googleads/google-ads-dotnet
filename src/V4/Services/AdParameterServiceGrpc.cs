...
namespace Google.Ads.GoogleAds.V4.Services {
  ...
  public static partial class AdParameterService
  {
    ...
    static readonly grpc::Marshaller<global::Google.Ads.GoogleAds.V4.Services.GetAdParameterRequest> __Marshaller_google_ads_googleads_v4_services_GetAdParameterRequest = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Ads.GoogleAds.V4.Services.GetAdParameterRequest.Parser));
    static readonly grpc::Marshaller<global::Google.Ads.GoogleAds.V4.Resources.AdParameter> __Marshaller_google_ads_googleads_v4_resources_AdParameter = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Ads.GoogleAds.V4.Resources.AdParameter.Parser));
    static readonly grpc::Marshaller<global::Google.Ads.GoogleAds.V4.Services.MutateAdParametersRequest> __Marshaller_google_ads_googleads_v4_services_MutateAdParametersRequest = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Ads.GoogleAds.V4.Services.MutateAdParametersRequest.Parser));
    static readonly grpc::Marshaller<global::Google.Ads.GoogleAds.V4.Services.MutateAdParametersResponse> __Marshaller_google_ads_googleads_v4_services_MutateAdParametersResponse = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Ads.GoogleAds.V4.Services.MutateAdParametersResponse.Parser));
