...
namespace Google.Ads.GoogleAds.V4.Services
{
    ...
    public sealed partial class ClickViewServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetClickViewSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class ClickViewServiceClient
    {
        ...
        /// <remarks>The default ClickViewService scopes are:<list type="bullet"></list></remarks>
