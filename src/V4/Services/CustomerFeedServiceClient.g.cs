...
namespace Google.Ads.GoogleAds.V4.Services
{
    ...
    public sealed partial class CustomerFeedServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetCustomerFeedSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings MutateCustomerFeedsSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class CustomerFeedServiceClient
    {
        ...
        /// <remarks>The default CustomerFeedService scopes are:<list type="bullet"></list></remarks>
