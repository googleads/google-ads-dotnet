...
namespace Google.Ads.GoogleAds.V4.Services
{
    ...
    public sealed partial class GoogleAdsServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings SearchStreamSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings MutateSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class GoogleAdsServiceClient
    {
        ...
        /// <remarks>The default GoogleAdsService scopes are:<list type="bullet"></list></remarks>
