...
namespace Google.Ads.GoogleAds.V4.Services {
  ...
  public static partial class KeywordPlanAdGroupKeywordService
  {
    ...
    static readonly grpc::Marshaller<global::Google.Ads.GoogleAds.V4.Services.GetKeywordPlanAdGroupKeywordRequest> __Marshaller_google_ads_googleads_v4_services_GetKeywordPlanAdGroupKeywordRequest = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Ads.GoogleAds.V4.Services.GetKeywordPlanAdGroupKeywordRequest.Parser));
    static readonly grpc::Marshaller<global::Google.Ads.GoogleAds.V4.Resources.KeywordPlanAdGroupKeyword> __Marshaller_google_ads_googleads_v4_resources_KeywordPlanAdGroupKeyword = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Ads.GoogleAds.V4.Resources.KeywordPlanAdGroupKeyword.Parser));
    static readonly grpc::Marshaller<global::Google.Ads.GoogleAds.V4.Services.MutateKeywordPlanAdGroupKeywordsRequest> __Marshaller_google_ads_googleads_v4_services_MutateKeywordPlanAdGroupKeywordsRequest = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Ads.GoogleAds.V4.Services.MutateKeywordPlanAdGroupKeywordsRequest.Parser));
    static readonly grpc::Marshaller<global::Google.Ads.GoogleAds.V4.Services.MutateKeywordPlanAdGroupKeywordsResponse> __Marshaller_google_ads_googleads_v4_services_MutateKeywordPlanAdGroupKeywordsResponse = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Ads.GoogleAds.V4.Services.MutateKeywordPlanAdGroupKeywordsResponse.Parser));
