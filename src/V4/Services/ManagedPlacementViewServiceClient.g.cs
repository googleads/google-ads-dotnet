...
namespace Google.Ads.GoogleAds.V4.Services
{
    ...
    public sealed partial class ManagedPlacementViewServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetManagedPlacementViewSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class ManagedPlacementViewServiceClient
    {
        ...
        /// <remarks>The default ManagedPlacementViewService scopes are:<list type="bullet"></list></remarks>
