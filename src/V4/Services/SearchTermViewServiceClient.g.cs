...
namespace Google.Ads.GoogleAds.V4.Services
{
    ...
    public sealed partial class SearchTermViewServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetSearchTermViewSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class SearchTermViewServiceClient
    {
        ...
        /// <remarks>The default SearchTermViewService scopes are:<list type="bullet"></list></remarks>
