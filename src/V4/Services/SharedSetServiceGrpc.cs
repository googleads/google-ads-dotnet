...
namespace Google.Ads.GoogleAds.V4.Services {
  ...
  public static partial class SharedSetService
  {
    ...
    static readonly grpc::Marshaller<global::Google.Ads.GoogleAds.V4.Services.GetSharedSetRequest> __Marshaller_google_ads_googleads_v4_services_GetSharedSetRequest = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Ads.GoogleAds.V4.Services.GetSharedSetRequest.Parser));
    static readonly grpc::Marshaller<global::Google.Ads.GoogleAds.V4.Resources.SharedSet> __Marshaller_google_ads_googleads_v4_resources_SharedSet = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Ads.GoogleAds.V4.Resources.SharedSet.Parser));
    static readonly grpc::Marshaller<global::Google.Ads.GoogleAds.V4.Services.MutateSharedSetsRequest> __Marshaller_google_ads_googleads_v4_services_MutateSharedSetsRequest = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Ads.GoogleAds.V4.Services.MutateSharedSetsRequest.Parser));
    static readonly grpc::Marshaller<global::Google.Ads.GoogleAds.V4.Services.MutateSharedSetsResponse> __Marshaller_google_ads_googleads_v4_services_MutateSharedSetsResponse = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Ads.GoogleAds.V4.Services.MutateSharedSetsResponse.Parser));
