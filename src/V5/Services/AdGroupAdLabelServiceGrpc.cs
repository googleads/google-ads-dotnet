...
namespace Google.Ads.GoogleAds.V5.Services {
  ...
  public static partial class AdGroupAdLabelService
  {
    ...
    static readonly grpc::Marshaller<global::Google.Ads.GoogleAds.V5.Services.GetAdGroupAdLabelRequest> __Marshaller_google_ads_googleads_v5_services_GetAdGroupAdLabelRequest = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Ads.GoogleAds.V5.Services.GetAdGroupAdLabelRequest.Parser));
    static readonly grpc::Marshaller<global::Google.Ads.GoogleAds.V5.Resources.AdGroupAdLabel> __Marshaller_google_ads_googleads_v5_resources_AdGroupAdLabel = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Ads.GoogleAds.V5.Resources.AdGroupAdLabel.Parser));
    static readonly grpc::Marshaller<global::Google.Ads.GoogleAds.V5.Services.MutateAdGroupAdLabelsRequest> __Marshaller_google_ads_googleads_v5_services_MutateAdGroupAdLabelsRequest = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Ads.GoogleAds.V5.Services.MutateAdGroupAdLabelsRequest.Parser));
    static readonly grpc::Marshaller<global::Google.Ads.GoogleAds.V5.Services.MutateAdGroupAdLabelsResponse> __Marshaller_google_ads_googleads_v5_services_MutateAdGroupAdLabelsResponse = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Ads.GoogleAds.V5.Services.MutateAdGroupAdLabelsResponse.Parser));
