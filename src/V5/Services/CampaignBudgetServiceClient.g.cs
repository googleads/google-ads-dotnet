...
namespace Google.Ads.GoogleAds.V5.Services
{
    ...
    public sealed partial class CampaignBudgetServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetCampaignBudgetSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings MutateCampaignBudgetsSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class CampaignBudgetServiceClient
    {
        ...
        /// <remarks>The default CampaignBudgetService scopes are:<list type="bullet"></list></remarks>
