...
namespace Google.Ads.GoogleAds.V5.Services {
  ...
  public static partial class FeedItemService
  {
    ...
    static readonly grpc::Marshaller<global::Google.Ads.GoogleAds.V5.Services.GetFeedItemRequest> __Marshaller_google_ads_googleads_v5_services_GetFeedItemRequest = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Ads.GoogleAds.V5.Services.GetFeedItemRequest.Parser));
    static readonly grpc::Marshaller<global::Google.Ads.GoogleAds.V5.Resources.FeedItem> __Marshaller_google_ads_googleads_v5_resources_FeedItem = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Ads.GoogleAds.V5.Resources.FeedItem.Parser));
    static readonly grpc::Marshaller<global::Google.Ads.GoogleAds.V5.Services.MutateFeedItemsRequest> __Marshaller_google_ads_googleads_v5_services_MutateFeedItemsRequest = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Ads.GoogleAds.V5.Services.MutateFeedItemsRequest.Parser));
    static readonly grpc::Marshaller<global::Google.Ads.GoogleAds.V5.Services.MutateFeedItemsResponse> __Marshaller_google_ads_googleads_v5_services_MutateFeedItemsResponse = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Ads.GoogleAds.V5.Services.MutateFeedItemsResponse.Parser));
