...
namespace Google.Ads.GoogleAds.V5.Services
{
    ...
    public sealed partial class FeedServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings MutateFeedsSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class FeedServiceClient
    {
        ...
        /// <remarks>The default FeedService scopes are:<list type="bullet"></list></remarks>
