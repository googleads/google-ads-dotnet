...
namespace Google.Ads.GoogleAds.V5.Services
{
    ...
    public sealed partial class IncomeRangeViewServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetIncomeRangeViewSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class IncomeRangeViewServiceClient
    {
        ...
        /// <remarks>The default IncomeRangeViewService scopes are:<list type="bullet"></list></remarks>
