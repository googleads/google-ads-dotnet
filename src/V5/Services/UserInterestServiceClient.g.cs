...
namespace Google.Ads.GoogleAds.V5.Services
{
    ...
    public sealed partial class UserInterestServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetUserInterestSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class UserInterestServiceClient
    {
        ...
        /// <remarks>The default UserInterestService scopes are:<list type="bullet"></list></remarks>
