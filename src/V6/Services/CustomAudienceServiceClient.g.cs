...
namespace Google.Ads.GoogleAds.V6.Services
{
    ...
    public sealed partial class CustomAudienceServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetCustomAudienceSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings MutateCustomAudiencesSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class CustomAudienceServiceClient
    {
        ...
        /// <remarks>The default CustomAudienceService scopes are:<list type="bullet"></list></remarks>
