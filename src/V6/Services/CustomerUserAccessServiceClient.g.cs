...
namespace Google.Ads.GoogleAds.V6.Services
{
    ...
    public sealed partial class CustomerUserAccessServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetCustomerUserAccessSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings MutateCustomerUserAccessSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class CustomerUserAccessServiceClient
    {
        ...
        /// <remarks>The default CustomerUserAccessService scopes are:<list type="bullet"></list></remarks>
