...
namespace Google.Ads.GoogleAds.V6.Services
{
    ...
    public sealed partial class ExtensionFeedItemServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetExtensionFeedItemSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings MutateExtensionFeedItemsSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class ExtensionFeedItemServiceClient
    {
        ...
        /// <remarks>The default ExtensionFeedItemService scopes are:<list type="bullet"></list></remarks>
