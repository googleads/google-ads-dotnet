...
namespace Google.Ads.GoogleAds.V6.Services
{
    ...
    public sealed partial class LandingPageViewServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetLandingPageViewSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class LandingPageViewServiceClient
    {
        ...
        /// <remarks>The default LandingPageViewService scopes are:<list type="bullet"></list></remarks>
