...
namespace Google.Ads.GoogleAds.V6.Services
{
    ...
    public sealed partial class SharedSetServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetSharedSetSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings MutateSharedSetsSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
