...
namespace Google.Ads.GoogleAds.V6.Services
{
    ...
    public sealed partial class ThirdPartyAppAnalyticsLinkServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetThirdPartyAppAnalyticsLinkSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings RegenerateShareableLinkIdSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class ThirdPartyAppAnalyticsLinkServiceClient
    {
        ...
        /// <remarks>The default ThirdPartyAppAnalyticsLinkService scopes are:<list type="bullet"></list></remarks>
