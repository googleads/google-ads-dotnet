...
using static Google.Ads.GoogleAds.V9.Enums.FeedItemTargetTypeEnum.Types;
using static Google.Ads.GoogleAds.V9.Enums.PlaceholderTypeEnum.Types;
using static Google.Ads.GoogleAds.V9.Enums.ProductBiddingCategoryLevelEnum.Types;
using static Google.Ads.GoogleAds.V9.Enums.SimulationModificationMethodEnum.Types;
using static Google.Ads.GoogleAds.V9.Enums.SimulationTypeEnum.Types;
