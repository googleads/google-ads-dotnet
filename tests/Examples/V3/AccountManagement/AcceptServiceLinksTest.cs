...
{
    /// <summary>
    /// Tests the AcceptServiceLinks code example.
    /// </summary>
    [TestFixture]
    [Category("CodeExamples")]
    internal class AcceptServiceLinksTest : ExampleTestsBase
    {
        /// <summary>
        /// Inits this instance.
        /// </summary>
        ...
        public void TestRun()
        {
            RunExample(delegate ()
            {
                new AcceptServiceLinks().Run(client, config.ClientCustomerId);
            });
        }
    }
}
