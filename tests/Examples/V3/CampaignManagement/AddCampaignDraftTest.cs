...
{
    /// <summary>
    /// Tests the AddCampaignDraft code example.
    /// </summary>
    [TestFixture]
    [Category("CodeExamples")]
    internal class AddCampaignDraftTest : ExampleTestsBase
    {
        /// <summary>
        ...
        public void Init()
        {
            ...
            string campaignResourceName = ExampleTestsUtils.CreateCampaign(client,
                budgetResourceName);
            baseCampaignId = ExampleTestsUtils.GetCampaign(client, campaignResourceName);
        }
        ...
        public void TestRun()
        {
            RunExample(delegate ()
            {
                new AddCampaignDraft().Run(client, config.ClientCustomerId, baseCampaignId);
            });
        }
    }
}
