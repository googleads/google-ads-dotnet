...
{
    /// <summary>
    /// Tests the UpdateCampaign code example.
    /// </summary>
    [TestFixture]
    [Category("CodeExamples")]
    internal class UpdateCampaignTest : ExampleTestsBase
    {
        /// <summary>
        ...
        public void TestRun()
        {
            RunExample(delegate ()
            {
                new UpdateCampaign().Run(client, config.ClientCustomerId, campaignId);
            });
        }
    }
}
