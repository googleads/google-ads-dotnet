...
{
    /// <summary>
    /// Tests the AddResponsiveSearchAd code example.
    /// </summary>
    [TestFixture]
    [Category("CodeExamples")]
    internal class AddResponsiveSearchAdTest : ExampleTestsBase
    {
        /// <summary>
        ...
        public void TestRun()
        {
            RunExample(delegate ()
            {
                new AddResponsiveSearchAd().Run(client, config.ClientCustomerId, adGroupId);
            });
        }
    }
}
