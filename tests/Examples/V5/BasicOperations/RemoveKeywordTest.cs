...
{
    /// <summary>
    /// Tests the RemoveKeyword code example.
    /// </summary>
    [TestFixture]
    [Category("CodeExamples")]
    internal class RemoveKeywordTest : ExampleTestsBase
    {
        /// <summary>
        ...
        public void TestRun()
        {
            RunExample(delegate ()
            {
                new RemoveKeyword().Run(client, config.ClientCustomerId, adGroupId, keywordId);
            });
        }
    }
}
