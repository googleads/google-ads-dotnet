...
{
    /// <summary>
    /// Tests the UpdateAdGroup code example.
    /// </summary>
    [TestFixture]
    [Category("CodeExamples")]
    internal class UpdateAdGroupTest : ExampleTestsBase
    {
        /// <summary>
        ...
        public void TestRun()
        {
            RunExample(delegate ()
            {
                new UpdateAdGroup().Run(client, config.ClientCustomerId, adGroupId, 10_000_000);
            });
        }
        ...
        /// </summary>
        [Test]
        public void TestRunWithEmptyBid()
        {
            RunExample(delegate ()
            {
                new UpdateAdGroup().Run(client, config.ClientCustomerId, adGroupId, null);
            });
        }
    }
}
