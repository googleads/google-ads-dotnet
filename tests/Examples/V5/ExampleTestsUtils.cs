...
using static Google.Ads.GoogleAds.V5.Enums.CampaignExperimentTrafficSplitTypeEnum.Types;
...
namespace Google.Ads.GoogleAds.Tests.Examples.V5
{
    internal class ExampleTestsUtils
    {
        ...
        internal static long GetCampaign(GoogleAdsClient client, string campaignResourceName)
        {
            ...
            return GetGoogleAdsRows(client, query).First().Campaign.Id;
        }
        ...
        internal static long GetAdGroup(GoogleAdsClient client, string adGroupResourceName)
        {
            ...
            return GetGoogleAdsRows(client, query).First().AdGroup.Id;
        }
        ...
        internal static long GetAdGroupAd(GoogleAdsClient client, string adGroupAdResourceName)
        {
            ...
            return GetGoogleAdsRows(client, query).First().AdGroupAd.Ad.Id;
        }
        ...
        internal static long GetKeyword(GoogleAdsClient client, string adGroupCriterionResourceName)
        {
            ...
            return GetGoogleAdsRows(client, query).First().AdGroupCriterion.CriterionId;
        }
            ...
            string campaignDraftResourceName)
        {
            ...
            CampaignExperimentServiceClient campaignExperimentService =
                client.GetService(Services.V5.CampaignExperimentService);
            ...
            long baseCampaignId)
        {
            ...
            CampaignDraftServiceClient campaignDraftService =
                client.GetService(Services.V5.CampaignDraftService);
