...
{
    /// <summary>
    /// Tests the AddExpandedTextAds code example.
    /// </summary>
    [TestFixture]
    [Category("CodeExamples")]
    internal class AddExpandedTextAdsTest : ExampleTestsBase
    {
        /// <summary>
        ...
        public void TestRun()
        {
            RunExample(delegate ()
            {
                new AddExpandedTextAds().Run(client, config.ClientCustomerId, adGroupId);
            });
        }
    }
}
