...
{
    /// <summary>
    /// Tests the RemoveAd code example.
    /// </summary>
    [TestFixture]
    [Category("CodeExamples")]
    internal class RemoveAdTest : ExampleTestsBase
    {
        /// <summary>
        ...
        /// <summary>
        /// The ad group ad ID for test purposes.
        /// </summary>
        ...
        public void Init()
        {
            ...
            adGroupAdId = ExampleTestsUtils.GetAdGroupAd(client, adGroupAdResourceName);
        }
        ...
        public void TestRun()
        {
            RunExample(delegate ()
            {
                new RemoveAd().Run(client, config.ClientCustomerId, adGroupId, adGroupAdId);
            });
        }
    }
}
