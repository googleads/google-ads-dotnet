...
using static Google.Ads.GoogleAds.V6.Enums.CampaignExperimentTrafficSplitTypeEnum.Types;
...
using static Google.Ads.GoogleAds.V6.Enums.ServedAssetFieldTypeEnum.Types;
...
namespace Google.Ads.GoogleAds.Tests.Examples.V6
{
    internal class ExampleTestsUtils
    {
            ...
            string experimentResourceName)
        {
            ...
            return GetGoogleAdsRows(client, query).First().CampaignExperiment.Id;
        }
