...
namespace Google.Ads.GoogleAds.V1.Services.Tests
{
    ...
    public class GeneratedCampaignLabelServiceClientTest
    {
        ...
        public void MutateCampaignLabels2()
        {
            ...
            string customerId = "customerId-1772061412";
            IEnumerable<CampaignLabelOperation> operations = new List<CampaignLabelOperation>();
            MutateCampaignLabelsResponse response = client.MutateCampaignLabels(customerId, operations);
            Assert.AreEqual(expectedResponse, response);
            mockGrpcClient.VerifyAll();
        }
        ...
        public async Task MutateCampaignLabelsAsync2()
        {
            ...
            string customerId = "customerId-1772061412";
            IEnumerable<CampaignLabelOperation> operations = new List<CampaignLabelOperation>();
            MutateCampaignLabelsResponse response = await client.MutateCampaignLabelsAsync(customerId, operations);
            Assert.AreEqual(expectedResponse, response);
            mockGrpcClient.VerifyAll();
        }
